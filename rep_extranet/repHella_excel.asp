		...
		if strTipoPedimento  = "1" then
			...
			'strSQL = "SELECT tipopr01, valmer01,factmo01, p_dta101, t_reca01, i_dta101, cvecli01, refcia01, fecpag01, valfac01, fletes01, segros01, cvepvc01, tipcam01, patent01, numped01, totbul01, cveped01, cveadu01, desf0101, nompro01, cvepod01, nombar01, tipopr01, fecent01 FROM ssdagi01 WHERE fecpag01 >='"&FormatoFechaInv(strDateIni)&"' AND fecpag01 <='"&FormatoFechaInv(strDateFin)&"' " & Permi & " and firmae01 !='' order by refcia01"
			 strSQL = "SELECT concat(concat(concat(concat(concat(concat(ltrim(substring(year(FECPAG01),3,2)),'-'),adusec01 ),'-'),PATENT01),'-'),NUMPED01) as IMPORTA," & _
					  ...
					  "       (firmae01   <> '')   and " & _
					  "		  cveped01 <> 'R1' and cveped01 <> 'F5' and " & _
		...
		if not trim(strSQL)="" then
			...
			if not RsRep.eof then
			   ...
			   'oExcel.Cells(intColumna,18).Value = "PREVALIDACION"
				...
				strHTML = strHTML & "<td width=""55""  bgcolor=""#339966"" nowrap><strong><font color=""#FFFFFF"" size=""1"" face=""Arial, Helvetica, sans-serif""> NOTA INTERNA         </font></strong></td>" & chr(13) & chr(10)
				...
				While NOT RsRep.EOF
					...
					strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">                                                       </font></td>" & chr(13) & chr(10) 'NOTA INTERNA
	...
	'******************************************************************************************************************************
		...
		if not trim(strSQL)="" then
	        ...
	        if not RsRep.eof then
			 ...
			 strHTML = strHTML & "<td width=""75""  bgcolor=""#339966"" nowrap><strong><font color=""#FFFFFF"" size=""1"" face=""Arial, Helvetica, sans-serif""> NOTA INTERNA      </font></strong></td>" & chr(13) & chr(10) ' Nota interna
			 ...
			 strHTML = strHTML & "<td width=""75""  bgcolor=""#339966"" nowrap><strong><font color=""#FFFFFF"" size=""1"" face=""Arial, Helvetica, sans-serif""> IDENTIFICADOR EB      </font></strong></td>" & chr(13) & chr(10) ' Identificador EB
                  ...
                  Set RsDetFracciones = Server.CreateObject("ADODB.Recordset")
                     ...
                     if cdbl( TasaIGI ) <= 0 then
                         ...
                         strDetMercancias= " SELECT caco05,                              " & _
										   ...
										   "		if(caco05 is not null and caco05 > 0, round(((factmo01/facmon39)*vafa05)/caco05,12), -1) as 'xPreUniok', " & _
										   "		monfac39	as mExt						  " & _
                         ...
                         if not RsDetMercancias.eof then ' si tiene fracciones
                            While not RsDetMercancias.eof ' recorremos las fracciones
								...
								' End if
								 xPreUni = RsDetMercancias.Fields.Item("xPreUniok").value
							   ...
							   strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> "  & " "  &"                     </font></td>" & chr(13) & chr(10) 'VENDEDOR     Nota interna
							   ...
							   strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">  "  & " "  &"                           </font></td>" & chr(13) & chr(10) 'VENDEDOR     Identificador EB
                            ...
                            wend
							   ...
							   strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " &               "          </font></td>" & chr(13) & chr(10) 'Identificador EB
                               strHTML = strHTML&"</tr>"& chr(13) & chr(10)

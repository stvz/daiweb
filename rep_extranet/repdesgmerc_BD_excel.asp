...
if strCodError = "0" then
  ...
  if not arrConcepto(1) = "" then
    ...
    Next
      ...
      strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Numero de Proveedor Aduanero</td>" & chr(13) & chr(10)
...
RsRep6.MoveFirst'Va al primer registro
  ...
  'Cuando hay varios registros
    ...
    strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">&nbsp;</font></td>" & chr(13) & chr(10)'Status
		...
		strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">&nbsp;</font></td>" & chr(13) & chr(10)'Numero BD de proveedor aduanero
...
'Pinta el registro de resumen para cada referencia
  ...
  strHTML = strHTML&"<td width=""90"" bgcolor =""#99FFCC""  nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & strNumPed & "</font></td>" & chr(13) & chr(10) 'Numero de Pedimento
	...
	strHTML = strHTML&"<td width=""90"" bgcolor =""#99FFCC""  nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"& RegresaProveedorAduan(strRefer) &"</font></td>" & chr(13) & chr(10) 'Numero BD de proveedor aduanero
...
strHTML2 = ""
  ...
  strHTML2 = strHTML2&"<td width=""90"" bgcolor =""#99CCFF""  nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">&nbsp;</font></td>" & chr(13) & chr(10) 'Numero de Pedimento
	...
	strHTML2 = strHTML2&"<td width=""90"" bgcolor =""#99CCFF""  nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">&nbsp;</font></td>" & chr(13) & chr(10) 'Numero BD de proveedor aduanero
...
strHTML3 = ""
  ...
  strHTML3 = strHTML3&"<td width=""90"" bgcolor =""#CCCCFF""  nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">&nbsp;</font></td>" & chr(13) & chr(10) 'Numero de Pedimento
	...
	strHTML3 = strHTML3&"<td width=""90"" bgcolor =""#CCCCFF""  nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">&nbsp;</font></td>" & chr(13) & chr(10) 'Numero BD de proveedor aduanero

...
'http://rkzego.no-ip.org/PortalMySQL/Extranet/ext-Asp/reportes/Rep_UL_IDOT_DEMOSIR.asp?finicio="2013-09-01"&ffinal="2013-10-07"&tipope="i"&OficinaG="lzr"
...
Response.Addheader "Content-Disposition", "attachment; filename=Booklet_IDOT_.xls"'
...
fechaini = "2013-08-01"'Request.QueryString("finicio")
fechafin = "2013-08-31"'Request.QueryString("ffinal")
oficina = "lzr"'Request.QueryString("OficinaG")
'fechaini="2013-06-01"
'fechafin="2013-06-15"
...
<td height=52 class=xl28 id="_x0000_s1025" x:autofilter="all"
  ...
  style='width:159pt'>Domicilio Fiscal del Proveedor</td>
 ...
 <td class=xl28 id="_x0000_s1041" x:autofilter="all" width=100
  ...
  style='mso-spacerun:yes'> </span></td>
      <td class=xl46 id="_x0000_s1045" x:autofilter="all" width=100
  ...
  style='mso-spacerun:yes'> </span></td>
  <%'<td class=xl39 id="_x0000_s1049" x:autofilter="all" width=100 
  'style='width:75pt' x:str="Peso Neto">Peso Neto<span
  'style='mso-spacerun:yes'> </span></td>
  %>
  <td class=xl39 id="_x0000_s1049" x:autofilter="all" width=100 
  style='width:75pt' x:str="Codigo de Producto (SKU)">Codigo de Producto (SKU)<span
  style='mso-spacerun:yes'> </span></td>
  ...
  <td class=xl38 id="_x0000_s1056" x:autofilter="all" width=100
  style='width:75pt' x:str="Detalle de contenedor ">Detalle de contenedor</td>
    <td class=xl46 id="_x0000_s1045" x:autofilter="all" width=100
  ...
  style='width:75pt'>Fecha de Factura</td>
    <td class=xl46 id="_x0000_s1045" x:autofilter="all" width=100
  style='width:75pt'>Fecha Entrada</td>
  ...
  style='width:75pt'>Fecha Desaduanamiento</td>
    <td class=xl46 id="_x0000_s1045" x:autofilter="all" width=100
  style='width:75pt'>Fecha de Entrega</td>
    <td class=xl46 id="_x0000_s1045" x:autofilter="all" width=100
  style='width:75pt'>Arribo vs Despacho</td>
    <td class=xl46 id="_x0000_s1045" x:autofilter="all" width=100
  style='width:75pt'>Fecha Vacio</td>
 ...
 <td class=xl53 id="_x0000_s1081" x:autofilter="all" width=100
  ...
  style='mso-spacerun:yes'> </span></td>
   <td class=xl54 id="_x0000_s1092" x:autofilter="all" width=100
  style='width:75pt' x:str=" Valor de la Mercancia en aduna"><span
  style='mso-spacerun:yes'>  </span>Valor de la Mercancia en aduana<span
  style='mso-spacerun:yes'> </span></td>
  ...
  style='mso-spacerun:yes'> </span></td>
   <td class=xl46 id="_x0000_s1092" x:autofilter="all" width=100
  style='width:75pt' x:str="ECI"><span
  style='mso-spacerun:yes'>  </span>ECI<span
  style='mso-spacerun:yes'> </span></td>
  ...
  style='width:75pt' x:str="CONEXION DE REFRIGERADO (Costo Aduanal)"><span
  style='mso-spacerun:yes'> </span>CONEXION DE REFRIGERADO (Costo Aduanal)<span style='mso-spacerun:yes'> </span></td>
    <td class=xl61 id="_x0000_s1119" x:autofilter="all" width=100
  style='width:75pt' x:str="CONEXION DE REFRIGERADO (Costo Directo)"><span
  style='mso-spacerun:yes'> </span>CONEXION DE REFRIGERADO (Costo Directo)<span style='mso-spacerun:yes'> </span></td>
    <td class=xl61 id="_x0000_s1119" x:autofilter="all" width=100
  style='width:75pt' x:str="MANIOBRAS (Tarifa FLAT)"><span
  style='mso-spacerun:yes'> </span>MANIOBRAS (Tarifa FLAT)"<span style='mso-spacerun:yes'> </span></td>
...
Dim sqlQuery
	...
	if oficina<>"Todas"then
		if oficina="dai" then
			...
			sqlQuery=sqlQuery & QueryMySql("dai2")
		else
			sqlQuery=QueryMySql(Oficina)
		end if
	else 
...
'response.end()
	...
	while not act2.eof
		...
		if (act2.fields("cveped").value<>"G1") then
			...
			genera_html "d",act2.fields("Rectificacion").value,"center" 'Rectificacion S/N
			...
			if act2.fields("CUENTA").value<>" " then
				genera_html "d",retornaCuenta(rcli),"center"  'Cuenta 
			else
				genera_html "d",act2.fields("CUENTA").value,"center"  'Cuenta 
			end if
			if act2.fields("CECO").value<>" " then
				genera_html "d",retornaCECO(rcli),"center"  'CECO
			else
				genera_html "d",act2.fields("CECO").value,"center"  'CECO
			end if
			...
			genera_html "d",act2.fields("TipMerc").value,"center" 'Tipo mercancia
		else
			...
			if act2.fields("CUENTA").value<>" " then
				...
				genera_html "d",retornaCuenta(rcli&" Esta es cuenta:"&act2.fields("CUENTA").value),"center"  'Cuenta 
			end if 
			if act2.fields("CECO").value<>" " then
				genera_html "d",act2.fields("CECO").value,"center"  'CECO
			...
			genera_html "d",act2.fields("TipMercG1").value,"center" 'Tipo mercancia				
		...
		'genera_html "d",act2.fields("PesoNeto").value,"center" 'Peso neto Agregado el 20/05/2013
		genera_html "d",act2.fields("SKU").value,"center"  'SKU Codigo de Producto Agregado el 20/05/2013
		...
		if (ref <> refAux)then
			...
			genera_html "d",retornaCampoContenedores(act2.fields("Refe").value,"numcon40",mid(act2.fields("Refe").value,1,3)),"center"  'No de Contenedor 
			 if ((mid(act2.fields("Refe").value,1,3) ="RKU" or mid(act2.fields("Refe").value,1,3)="SAP" or mid(act2.fields("Refe").value,1,3)="ALC") and act2.fields("Tcar").value="2" )then
				genera_html "d",retornaCampoDetalleCont(act2.fields("Refe").value,mid(act2.fields("Refe").value,1,3)),"center"  'Detalle de contenedor
			 else 
				genera_html "d","","center"
			 end if
			genera_html "d",act2.fields("NumeroBL").value,"center" 'Numero Guia BL 
			...
			genera_html "d",act2.fields("Fentrada").value,"center"  'Fecha entrada Contenedor
			...
			genera_html "d",act2.fields("Fentrega").value,"center" ' Fecha Entrega
			genera_html "d",act2.fields("Indicador").value,"center" ' Indicador Fecha Despacho vs Fecha arribo
			genera_html "d",act2.fields("Fvacio").value,"center" ' Fecha de Vacio
			...
			Subref = act2.fields("Ord FrcA").value
				if (ordenOcupado(Subref,act2.fields("Refe").value) = False)then
					...
					if (act2.fields("cveped").value<>"G1") then
						...
						genera_html "d",act2.fields("ValorAduana").value,"center" 'Valor en aduana Pedimento
						...
						genera_html "d",act2.fields("eci").value,"center"  ' MONTO DE RECUPERACION $  
				...
				genera_html "d","","center" ' ValorAduana
				genera_html "d",act2.fields("Valor Fletes MN").value,"center"  ' VALOR FLETES INTERNACIONAL M.N. 
				genera_html "d","","center"  'VALOR FLETES INTERNACIONAL USD
				genera_html "d",act2.fields("Seguros").value,"center"  ' SEGUROS 
				genera_html "d",act2.fields("Otros inc.").value,"center"  ' OTROS INCREMENTABLES 
		...
		genera_html "d",act2.fields("TotalImp").value,"center"  ' TOTAL IMPUESTOS 
		genera_html "d",act2.fields("TotalImpUSD").value,"center"  ' Total Impuestos USD 
		'-------------------EXTRA COSTOS-------------
		genera_html "d","N/A","center"  ' GASTOS ADUANA USD
		dim Omid, Demoras,Estadias,Maniobras, Almacenajes,CRCA,CRCD,Tflat
		Deroras=0
		Estadias=0
		Maniobras=0
		Almacenajes=0
		...
		CRCD=0
		Tflat=0
		Omid=mid(act2.fields("Refe").value,1,3)
		
		if (Omid="RKU" or Omid="ALC" or Omid="SAP") then
		
			Demoras =retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"DEMORAS"),"I",mid(act2.fields("Refe").value,1,3),"CA")
			genera_html "d",Demoras,"center"  ' DEMORAS 
			Estadias=retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"ESTADIAS"),"I",mid(act2.fields("Refe").value,1,3),"CA")
			genera_html "d",Estadias,"center"  ' ESTADIAS 
			Maniobras=retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"MANIOBRAS"),"I",mid(act2.fields("Refe").value,1,3),"CA")
			genera_html "d",Maniobras,"center"  ' MANIOBRAS  
			Almacenajes=retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"ALMACENAJES"),"I",mid(act2.fields("Refe").value,1,3),"CA")
			genera_html "d",Almacenajes,"center"  ' ALMACENAJES
			CRCA=retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"CONEXION REFRIGERADO"),"I",mid(act2.fields("Refe").value,1,3),"CA")
			genera_html "d",CRCA,"center" 'CONEXION DE REFRIGERADO Costo Aduanal
			CRCD=retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"CONEXION REFRIGERADO"),"I",mid(act2.fields("Refe").value,1,3),"CD")
			genera_html "d",CRCD,"center" ' CONEXION DE REFRIGERADO Costo Directo
			Tflat=retornaPagosHechosMaritimo(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"MANIOBRAS"),"I",mid(act2.fields("Refe").value,1,3),"CD")
			genera_html "d",Tflat,"center" 'MANIOBRAS TARIFA FLAT
		else 
			Demoras=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"DEMORAS"),"I",mid(act2.fields("Refe").value,1,3))
				genera_html "d",Demoras,"center"  ' DEMORAS 
			Estadias=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"ESTADIAS"),"I",mid(act2.fields("Refe").value,1,3))
				genera_html "d",Estadias,"center"  ' ESTADIAS 
			Maniobras=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"MANIOBRAS"),"I",mid(act2.fields("Refe").value,1,3))
				genera_html "d",Maniobras,"center"  ' MANIOBRAS
			Almacenajes=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"ALMACENAJES"),"I",mid(act2.fields("Refe").value,1,3))
			genera_html "d",Almacenajes,"center"  ' ALMACENAJES
			CRCA=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"CONEXION REFRIGERADO"),"I",mid(act2.fields("Refe").value,1,3))
			genera_html "d",CRCA,"center"  ' CONEXION DE REFRIGERADO Costo Aduanal
			genera_html "d","0","center"  ' CONEXION DE REFRIGERADO Costo Directo
			genera_html "d","0","center" 'MANIOBRAS TARIFA FLAT
		end if 
		...
		' TPH=0
			...
			STIMP=0
			STIVA=0
			' TPH=retornaTOTALPagosHechos(act2.fields("Refe").value,"I",mid(act2.fields("Refe").value,1,3))
			' DEM= retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"DEMORAS"),"I",mid(act2.fields("Refe").value,1,3))
				' EST = retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"ESTADIAS"),"I",mid(act2.fields("Refe").value,1,3))	
			' ALMAN=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"ALMACENAJES-MANIOBRAS"),"I",mid(act2.fields("Refe").value,1,3))
		' if ucase(mid(act2.fields("Refe").value,1,3)) ="RKU" or ucase(mid(act2.fields("Refe").value,1,3)) ="SAP" then
				' MAN=retornaPagosHechos(act2.fields("Refe").value,retornaConceptosPH(mid(act2.fields("Refe").value,1,3),"MANIOBRAS"),"I",mid(act2.fields("Refe").value,1,3))
		' end if
		if(revisaImpuestosFacturados( act2.fields("Refe").value,"I",mid(act2.fields("Refe").value,1,3)) <> 0 )then
				STIMP=sumaTotalImpuestos(act2.fields("Refe").value,mid(act2.fields("Refe").value,1,3),act2.fields("cveped").value)
				STIVA=sumaTotalIVA(act2.fields("Refe").value,mid(act2.fields("Refe").value,1,3),act2.fields("cveped").value)
		end if
		on error resume next
		dim cueta,TGD
		TGD=Demoras+Estadias+Maniobras+Almacenajes+CRCA+Tflat
		cuenta=retornaCampoCtaGastos(act2.fields("Refe").value,"cgas31",mid(act2.fields("Refe").value,1,3))
			...
			genera_html "d",retornaTipoUnidad(act2.fields("Refe").value,"I",mid(act2.fields("Refe").value,1,3)),"center" 'TIPO UNIDAD
			'/Lote 1
		else 
			'Lote 2
			genera_html "d","","center"  'No de Contenedor 
			genera_html "d","","center"  'Detalle de Contenedor
			genera_html "d",act2.fields("NumeroBL").value,"center" 'Numero Guia BL 
			genera_html "d",act2.fields("cveped").value,"center" 'Cve Pedimento
			genera_html "d",act2.fields("NumPedimento").value,"center"  'No. Pedimento
			genera_html "d",act2.fields("FechaPagoPed").value,"center"  'Fecha Pedimento
			...
			genera_html "d",act2.fields("Fentrega").value,"center" ' Fecha Entrega
			genera_html "d",act2.fields("Indicador").value,"center" ' Indicador Fecha Despacho vs Fecha arribo
			genera_html "d",act2.fields("Fvacio").value,"center" 'Fecha Vacio
			genera_html "d","","center"  'KPI Programación
			genera_html "d","","center"  'KPI Tránsito
			genera_html "d","","center"  'KPI Desaduanamiento
			genera_html "d","","center"  'KPI lead TIME
			...
			if (ordenOcupado(Subref,act2.fields("Refe").value) = False)then
				...
				if (act2.fields("cveped").value<>"G1") then
					genera_html "d",act2.fields("Presio Pag").value,"center"  ' Precio Pagado / valor comercial 
					genera_html "d",act2.fields("ValCom USD").value,"center"  '  Valor comercial USD 
					genera_html "d","","center" 'Valor en aduana Pedimento
		 ...
		 'Lote 1
			...
			genera_html "d","","center"  ' CONEXION DE REFRIGERADOS
			genera_html "d","","center"  ' CONEXION DE REFRIGERADOS (CD)
			genera_html "d","","center"  ' TOTAL GASTOS DIVERSOS 
			genera_html "d","","center"  ' MANIOBRAS TARIFA FLAT
			genera_html "d","","center"  ' TOTAL DE GASTOS DIVERSOS
			genera_html "d","","center"  ' TOTAL GASTOS DIVERSOS M.N
			genera_html "d","","center"  ' TOTAL GASTOS DIVERSOS USD
	       ...
	       if oficina = "RKU" then
		       ...
		       if oficina = "DAI" then
			           if topico = "ALMACENAJES" then
						...
						if topico = "MANIOBRAS" then
						 cad="127,82,102,35,6,11,3,141,63,315,219,257"
						end if
						if topico="CONEXION REFRIGERADO" then 	
						cad="60"
					end if
...
if conceptos<>"NE" then 	
	...
	sqlAct=sqlAct& "    where  i.rfccli01 in ('FME920608SM3')  and i.firmae01 <> ''  and cta.esta31 <> 'C'  "
...
"             inner join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.esta21 <> 'C'  and ep.tmov21 =dp.tmov21 " & _
"                  inner join  "& oficina &"_extranet.c21paghe as cp on cp.clav21 = ep.conc21 " & _
"    where  i.rfccli01 in ('FME920608SM3')  and i.firmae01 <> ''  and cta.esta31 <> 'C'  and ep.conc21 in ("&conceptos&") and i.refcia01 = '"&referencia&"'  group by Ref"
...
sqlAct =" select i.refcia01 as Ref,sum(dp.mont21*if(ep.deha21 = 'C',-1,1)) as Importe " & _
		...
		" inner join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.esta21 <> 'C'  and ep.tmov21 =dp.tmov21 " & _
		" where i.rfccli01 in ('FME920608SM3')  and i.refcia01 = '"&referencia&"'  and i.firmae01 <> ''  group by i.refcia01 "
...
'12 de septiembre Detalle de contenedor solicitado por laura Resendiz 
...
dim c,valor
 ...
 if oficina="SAP" or oficina="RKU" or oficina="LZR" then 
	sqlAct="select r.tbul01 as campo from "&oficina&"_extranet.c01refer as r where r.refe01 ='"&referencia&"' "
'elseif oficina="RKU" then
'	sqlAct="SELECT D.refe01 ,group_concat(D.marc01 separator ' - ' ) as campo FROM "&oficina&"_EXTRANET.d01conte AS D WHERE D.refe01 ='"&referencia&"' "
	...
	sqlAct="select  cast(group_concat(d01.CONTEN01,' (',d01.CANTI01 ,')', d01.CLASE01 separator ' / ') as char ) as campo from "&oficina&"_extranet.d01cdesc as d01 where d01.REFE01='"&referencia&"'   "	
end if
Set act2= Server.CreateObject("ADODB.Recordset")
conn12 = "DRIVER={MySQL ODBC 5.1 Driver}; SERVER=10.66.1.9; DATABASE="&oficina&"_extranet; UID=EXTRANET; PWD=rku_admin; OPTION=16427"
...
sqlAct="select group_concat(distinct if(cn4.tipcon40 in(1,2,3) ,'SECA',if(cn4.tipcon40 in(15,17),'REFRIGERADA','')) separator ' | ') As campo from "&oficina&"_extranet.sscont40 as cn4 LEFT JOIN  "&oficina&"_extranet.sstcon07 cn7 on cn4.tipcon40 =cn7.cvecon07 where cn4.refcia40 = '"& referencia &"' "
...
'OTRAS
if clave = "13000" or clave="14000" or clave="15005"  or clave="14015" then
val = "Todas"
end if
...
function sumaTotalImpuestos(referencia,oficina,clavepedimento)
dim c,valor
 c=chr(34)
 valor="0"
 ...
 if clavepedimento<>"R1" then 
	...
	sqlAct=" select ifnull(sum(import33),0) as campo from "& oficina &"_extranet.sscont33 as cf1 " & _
       " where cf1.cveimp33 in ('1', '6','15')   and refcia33 = '"&referencia&"' "
 end if
...
function sumaTotalIVA(referencia,oficina,clavepedimento)
dim c,valor
 c=chr(34)
 valor=0
 ...
 oficina = "LZR"
  ...
  if clavepedimento <>"R1" then 
	...
	sqlAct=" select ifnull(sum(import33),0) as campo from "& oficina &"_extranet.sscont33 as cf1 " & _
       " where cf1.cveimp33 in ('3')   and refcia33 = '"&referencia&"' "
  end if 
...
'" AND con.numcon40 = REPLACE(REPLACE(d01.marc01, '/', ''), '-', '') "
else 
condicion=""
end if
...
sqlAct="SELECT 	ifnull(SUM(IF(eph.deha21 = 'A', dph.mont21, (dph.mont21)*-1)),0) AS 'FleteNac'	" & _
	"FROM "&oficina&"_extranet.ssdagi01 AS imp LEFT JOIN  "&oficina&"_extranet.d31refer AS ref ON ref.refe31 = imp.refcia01 " & _
	...
	"WHERE imp.rfccli01 IN ('FME920608SM3') AND " & _
...
dim Oficina2
Oficina2=""
	if  Oficina="dai2" then 
		Oficina2="dai"
	else
		Oficina2=Oficina
	end if
sqlAct=""
sqlAct= sqlAct & "select i.refcia01,fr2.fraarn02,fr2.ordfra02,r.tcar01 as Tcar, " &_
  "i.cvecli01 as '1', "&_
  ...
  "if(i.cveped01='G1',fr2.d_mer102,ar.desc05 )as 'NameMat',  "&_
  "prv.nompro22 as 'Proveedor', "&_
  "r.rcli01 as 'RefCliente', "&_
  "replace(substring(r.rcli01 , "&_
  "position('CUENTA' in r.rcli01), "&_
  "if((position('/' in r.rcli01)>0),position('/' in r.rcli01),if(position(' OI' in r.rcli01)>0,position(' OI' in r.rcli01),if(position(';OI' in r.rcli01)>0,position(';OI' in r.rcli01),if(position(' CECO' in r.rcli01)>0,position(' CECO' in r.rcli01),0))))),'/','') as CUENTA, "&_
  "cast(substring(r.rcli01 ,position('ceco' in r.rcli01))as char) as CECO, "&_
  "ar.pedi05 as 'ODC', "&_
  "i.fecent01 Fentrada, "&_
  "(select  cast(ifnull(group_concat(distinct dcont.entc01),'-') as char)from "&Oficina2&"_extranet.d01conte as dcont  where dcont.refe01=i.refcia01 and dcont.entc01<>'0000-00-00') Fentrega , "&_
  "(select  cast(ifnull(group_concat(distinct dcont.fcarta01),'-') as char)from "&Oficina2&"_extranet.d01conte as dcont  where dcont.refe01=i.refcia01 and dcont.entc01<>'0000-00-00') Fvacio , "&_
  ...
  "i.pesobr01 as 'PesoB KG',    "&_
   "if(i.cveped01='G1',if(i.cvecli01=15004 and (r.forf01='' or r.forf01='FOB') ,'DDU',if(i.cvecli01=15002 and (r.forf01='' or r.forf01='FOB'),'DAP',r.forf01)),f.terfac39) as 'Imcoterms',    "
  if Oficina2="rku" or Oficina2="sap" or Oficina2="lzr" then
...
" group_concat(distinct g.numgui04) NumeroBL, "&_
  ...
  "(select if(rec.refcia06 is null,'N','S') from "&Oficina2&"_extranet.ssdagi01 as i2 left join "&Oficina2&"_extranet.ssrecp06 as rec on rec.reforg06 =i2.refcia01 where i2.refcia01=i.refcia01 and i2.firmae01<>'' and i2.firmae01 is not null group by i2.refcia01 ) as Rectificacion, "&_
  "Month(i.fecpag01) as 'Mes',     "&_
  "weekofyear(i.fecpag01) as 'Sem',    "&_
  "date_format(if(i.cveped01='G1',ar2.ffactp05,f.fecfac39),'%d/%m/%Y') as 'FechaFactura',    "&_
  ...
  "'PACK' TipMercG1 ,"&_
   ...
   "DATEDIFF(r.fdsp01,r.frev01) as 'Indicador', "&_
  "r.fdsp01 as 'F.Desaduanamiento',    "&_
  "fr.prepag02   as 'Presio Pag',     "&_
  "(select sum(va.vaduan02) as campo from "&Oficina2&"_extranet.ssfrac02 as va where va.refcia02 =i.refcia01) as ValorAduana , "&_
 ...
 "'' as '68', "&_
  ...
  "if(i.cveped01='G1',ar2.frac05,fr2.fraarn02) as '710', 	    "&_
  ...
  "imp.igi as '75 ',  imp.eci ,  "&_
  "imp.dta as 'Total Imp',    "&_
 ...
 "fr2.ordfra02 as '810',"&_
  ...
  "i.cveped01 as 'cveped',    "&_
   ...
   "if(i.cveped01='G1',ar2.candef05,ar.candef05) as PesoNeto, imp.TotalImp, (imp.TotalImp/i.tipcam01) TotalImpUSD,  "&_
   "if (i.cveped01='G1',if(ar2.cpro05<>'',ar2.cpro05,ar2.item05),if(ar.cpro05<>'',ar.cpro05,ar.item05)) as SKU, "&_
	"	if((mid(i.refcia01 ,1,3)='DAI' or (mid(i.refcia01 ,1,3)='PAN')),if(lin.desc01<>'',lin.desc01,lin.dir01) ,nav.nom01)  AS Naviera  "&_ 
    "from "&Oficina2&"_extranet.ssdagi01 as i     "&_
		" left join "&Oficina2&"_extranet.ssguia04 as g on g.refcia04=i.refcia01 and g.patent04=i.patent01 and g.adusec04=i.adusec01 and idngui04 =1 "&_
		"left join "&Oficina2&"_extranet.ssclie18 as cc on cc.cvecli18 = i.cvecli01     "&_
		"left join "&Oficina2&"_extranet.c01refer as r on r.refe01 = i.refcia01    "&_
		"LEFT join "&Oficina2&"_extranet.d31refer as ctar on  ctar.refe31 = i.refcia01     "&_
		"LEFT join "&Oficina2&"_extranet.e31cgast as cta on cta.cgas31 = ctar.cgas31  and cta.esta31 <> 'C'     "&_
        "left join "&Oficina2&"_extranet.ssfact39 as f on f.refcia39 = i.refcia01 and  f.adusec39 = i.adusec01 and f.patent39 = i.patent01  and f.terfac39<>''   "&_
        "left join "&Oficina2&"_extranet.c06barco as bar on bar.clav06 =r.cbuq01 "&_
        "left join "&Oficina2&"_extranet.c55navie as nav on nav.cve01 =bar.navi06 and nav.Status55='T' "&_
        " left join "&Oficina2&"_extranet.d05artic as ar on ar.refe05 = i.refcia01 and f.numfac39 = ar.fact05  and ar.refe05 = r.refe01    "&_
        "left join "&Oficina2&"_extranet.d05artic as ar2 on ar2.refe05 = i.refcia01    "&_
        "left join "&Oficina2&"_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and ar.frac05 = fr.fraarn02  and fr.ordfra02 = ar.agru05      "&_
		"left join "&Oficina2&"_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr2.fraarn02  and fr2.ordfra02 = ar2.agru05      "&_
        "left join "&Oficina2&"_extranet.ssprov22 as prv on prv.cvepro22 = i.cvepro01      "&_
        "left join "&Oficina2&"_extranet.ssumed31 as um on um.clavem31 = ar2.umco05       "&_
		...
		"from "&Oficina2&"_extranet.ssdagi01 as ii "&_
		"left join "&Oficina2&"_extranet.c01refer as rr  on rr.refe01=ii.refcia01 "&_
		"left join "&Oficina2&"_extranet.sscont36 as c36 on c36.refcia36=ii.refcia01 and c36.patent36=ii.patent01 "&_
		"left join "&Oficina2&"_extranet.sscont33 as c33 on c33.refcia33=ii.refcia01 and c33.patent33=ii.patent01 "&_
		"where ii.firmae01 is not null and ii.firmae01<>'' and ii.rfccli01 in('FME920608SM3') "&_
		"and rr.fdsp01 >='"&fechaini&"' and rr.fdsp01<='"&fechafin&"' "&_
		"group by ii.refcia01 "&_
		") as imp on imp.refcia01=i.refcia01 "&_
        "left join "&Oficina2&"_extranet.ssipar12 as ipar2 on ipar2.refcia12 = i.refcia01 and ipar2.ordfra12 = fr.ordfra02 and ipar2.cveide12 in ('PS','TG','TL','OC','AL')    "&_
        "left join "&Oficina2&"_extranet.ssmtra30  as transp on transp.clavet30 = i.cvemts01       "&_
		"left join "&Oficina2&"_extranet.c01airln as lin on lin.cvela01 =r.cvela01  "
	if Oficina<>"dai2" then					 
     sqlAct=sqlAct & "where cc.rfccli18 in ('FME920608SM3') and i.firmae01 is not null and i.firmae01 <> '' and i.cveped01<>'G1'and  i.fecpag01 >='"&fechaini&"' and i.fecpag01 <= '"&fechafin&"' "&_
  "group by i.refcia01,f.numfac39,ar.item05,fr.fraarn02,fr.ordfra02,ar.pfac05 "
 else 
    sqlAct=sqlAct &  "where cc.rfccli18 in ('FME920608SM3') and i.firmae01 is not null and i.firmae01 <> '' and i.cveped01='G1'and i.fecpag01  >='"&fechaini&"' and i.fecpag01 <= '"&fechafin&"' "&_
  "group by i.refcia01,f.numfac39,ar.item05,fr.fraarn02,fr.ordfra02,ar.pfac05,ar2.caco05 "
 end if
'response.write(sqlAct)
'response.end()
 QueryMySql=sqlAct

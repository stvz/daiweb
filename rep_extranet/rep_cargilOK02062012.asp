								  ...
								  %>
									<table width="854" border="1" cellspacing="3" cellpadding="3">
										  ...
										  <tr bgcolor="#C0C0C0" >
											 ...
											 <td width="50px" ><font size="1" color="#000000" > <b> CLIENTE             </b> </FONT></th>
										  </tr>
								  ...
								  Do while not RSPart.Eof
									  ...
									  %>
									   <tr>
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(cliente) %>  </font></td><!-- CLIENTE -->										 
									   </tr>
								  ...
								  Do while not RSPart.Eof
									  ...
									  %>
									   <tr>
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strfec) %>   </font></td><!-- FECHA LIBERACIÓN -->

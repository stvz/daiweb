	...
	Else
		...
		Do Until RSops.EOF
				...
				datos = datos &	"<tr>" &_
								...
								celdadatos(RSops.Fields.Item("Dias Transcurridos").Value)
...
function GeneraSQL
	...
	SQL = 	"SELECT 'IMPORTACION' as 'Tipo de Operacion', " &_
					...
					"IF(cau.c01causa is not null and cau.c01causa <> '', cau.c01causa,'No Capturada') as 'Causal', " &_
			...
			"WHERE i.cveped01 <> 'R1' " &_
					...
					"and (cta.anti31 > 0 OR cta.anti31 <> '' OR cta.anti31 IS NOT NULL) " & condicion &_
			"GROUP BY i.refcia01, cau.c01causa " &_

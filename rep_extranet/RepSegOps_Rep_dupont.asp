...
if  Session("GAduana") <> "" then %>
 ...
 "paiori02,d_mer102,numped01,if(fdoc01>fecent01,if(fdoc01>frev01,fdoc01,frev01),if(fecent01>frev01,fecent01,frev01)) as fini, " &_
 ...
 sql1="SELECT trim(concat(concat(concat(concat(concat(adusec01),'-'),patent01),'-'),numped01)) as Importa, " &_
 " feta01,fdoc01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01," &_
 " numped01,paiori02,d_mer102,if(fdoc01>feta01,if(fdoc01>fecent01,if(fdoc01>frev01,fdoc01,frev01), " &_
 " if(fecent01>frev01,fecent01,frev01)) as fini, " &_

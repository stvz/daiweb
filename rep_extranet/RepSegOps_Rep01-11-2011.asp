...
if  Session("GAduana") <> "" then %>
 ...
 "paiori02,group_concat(d_mer102),numped01,if(fdoc01>feta01,if(fdoc01>frev01,fdoc01,frev01),if(feta01>frev01,feta01,frev01)) as fini, " &_
       "fecent01 FROM ssdagi01 INNER JOIN c01refer on refe01 = refcia01 LEFT JOIN ssfrac02 ON refcia02 = refcia01 and patent01 = patent02 "&_
       "WHERE firmae01<>'' and rfccli01='" & Vrfc & "' and tipo01='1' and " &_
       "fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'R1' " & " GROUP BY refcia01 ORDER BY clie01, REFE01"
 ...
 sql1="SELECT trim(concat(concat(concat(concat(concat(adusec01),'-'),patent01),'-'),numped01)) as Importa, " &_
 " feta01,fdoc01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01," &_
 " numped01,paiori02,group_concat(d_mer102), if(fdoc01>feta01,if(fdoc01>frev01,fdoc01,frev01),if(feta01>frev01,feta01,frev01)) as fini, " &_
" fecent01 FROM ssdagi01 INNER JOIN c01refer on refe01= refcia01 LEFT JOIN ssfrac02 ON refcia01 = refcia02 AND patent01 = patent02 " &_
"WHERE firmae01<>'"&""&"'  " & permi & " and tipo01='1' "&_
" and fdsp01>='"&DateI&"' and refcia02=refcia01 and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " & " GROUP BY refcia01 ORDER BY clie01, REFE01"
                                        'Response.Write(sql1)
                                      end if
                                    else
                                      if Vckcve="0" then
...
"numped01,paiori02,desf0101, frec01 as fini " & _
 "FROM ssdage01 INNER JOIN c01refer on refe01 = refcia01 LEFT JOIN ssfrac02 ON refcia02 = refcia01 AND patent02 = patent01 " &_
 "WHERE firmae01<>'' and rfccli01='" & Vrfc & "' and tipo01='2' " &_
 "and fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'R1' " & " GROUP BY refcia01 ORDER BY clie01, REFE01"
                                        '     Response.Write(sql1)
                                      else
  ...
  sql1="SELECT trim(concat(concat(concat(concat(concat(adusec01),'-'),patent01),'-'),numped01)) as Exporta, " &_
      " feta01,fdoc01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01, " &_
  " numped01,paiori02,desf0101,frec01 as fini " &_
  "FROM ssdage01 INNER JOIN c01refer on refe01= refcia01 LEFT JOIN ssfrac02 ON refcia02 = refcia01 AND patent01 = patent02 " &_
  "WHERE firmae01 <> '' " & permi & " and tipo01='2'  and " &_
  "fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'R1' " & " GROUP BY refcia01 ORDER BY clie01, REFE01"
                                      '       Response.Write(sql1)
                                      end if
...
'**********************************************************************************************
                                    ...
                                    <%if mov="i" then%>
										 ...
										 <%if RS("group_concat(d_mer102)") <>"" then %>
										    <td align="center" nowrap><font size="1" face="Arial"><%=RS("group_concat(d_mer102)") %></font></td>
										 <%else%>

...
"             inner join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.esta21 <> 'C'  and ep.tmov21 =dp.tmov21 " & _
"                  inner join  "& oficina &"_extranet.c21paghe as cp on cp.clav21 = ep.conc21 " & _
"    where  i.rfccli01 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255')  and i.firmae01 <> ''  and cta.esta31 <> 'C'  and ep.conc21 in ("&conceptos&") and i.refcia01 = '"&referencia&"'  group by Ref"
...
sqlAct="SELECT 	ifnull(SUM(IF(eph.deha21 = 'A', dph.mont21, (dph.mont21)*-1)),0) AS 'FleteNac'	" & _
	...
	"WHERE imp.rfccli01 IN ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255') AND " & _
...
" group_concat(distinct g.numgui04) NumeroBL, "&_
  ...
  "(select if(rec.refcia06 is null,'N','S') from "&Oficina2&"_extranet.ssdagi01 as i2 left join "&Oficina2&"_extranet.ssrecp06 as rec on rec.reforg06 =i2.refcia01 " &_ 
  " left join "&Oficina2&"_extranet.ssdagi01 as i3 on i3.refcia01 =rec.refcia06 " & _
  " where i2.refcia01=i.refcia01 and i3.firmae01<>'' and i3.firmae01 is not null group by i2.refcia01 ) as Rectificacion, "&_
 ...
 "fr2.ordfra02 as '810',"&_
  ...
  "i.cveped01 as 'cveped',    "&_
   ...
   "if (i.cveped01='G1',if(ar2.cpro05<>'',ar2.cpro05,ar2.item05),if(ar.cpro05<>'',ar.cpro05,ar.item05)) as SKU, "&_
	...
	if Oficina<>"dai2" then					 
     sqlAct=sqlAct & "where cc.rfccli18 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255') and i.firmae01 is not null and i.firmae01 <> '' and i.cveped01<>'G1'and  i.fecpag01 >='"&fechaini&"' and i.fecpag01 <= '"&fechafin&"' "&_

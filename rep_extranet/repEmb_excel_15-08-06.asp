...
if not trim(strSQL)="" then
     ...
     ' Comienza el HTML, se pintan los titulos de las columnas
       ...
       strHTML = strHTML & "<table bordercolor=""#C1C1C1"" border=""2"" align=""center"" cellpadding=""0"" cellspacing=""0"">" & chr(13) & chr(10)
	     strHTML = strHTML & "<tr bgcolor=""#009966"" align=""center"">"& chr(13) & chr(10)
 	     ...
 	     if strTipoUsuario = MM_Cod_Cliente_Division then
		   ...
		   strHTML = strHTML & "<td width=""60"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">O.C. Nº </td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""90"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Factura Nº</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""90"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Descripción </td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""60"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Cantidad </td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""100"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Facturador </td>" & chr(13) & chr(10)
       ...
       strHTML = strHTML & "<td width=""90"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Referencia </td>" & chr(13) & chr(10)
       ...
       strHTML = strHTML & "<td width=""90""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Cve. Ped.  </td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""90""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Aduana  </td>" & chr(13) & chr(10)
       ...
       strHTML = strHTML & "<td width=""70""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Fletes USD</td>" & chr(13) & chr(10)
       ...
       strHTML = strHTML & "<td width=""100""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Cta de Gastos</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""140""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Fecha Cta de Gastos</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""145""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Gastos Aduanales</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""155""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Fecha llegada aduana</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""160""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Fecha Entrada Abbot</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""115""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Dias en transito</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""105""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Pais Vendedor</td>" & chr(13) & chr(10)
       strHTML = strHTML & "<td width=""90""  nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif""> Pais Origen</td>" & chr(13) & chr(10)

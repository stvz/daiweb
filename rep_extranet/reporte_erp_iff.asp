...
Response.Write(finicio)
Response.Write(ffinal)
...
%></tr><%
 ...
 ' Se  cambia los RFC por el de IFF
...
"    where cc.rfccli18 in ('IF&610526C95','IFF610526PQ6') and i.firmae01 is not null and i.firmae01 <> ''  and  i.fecpag01 >=  '"& finicio &"' and i.fecpag01 <= '"& ffinal &"' " & _
...
Subref = act2.fields("81").value
 if (ordenOcupado(Subref,act2.fields("29").value) = False)then
   ...
   '-----
	...
	genera_html "d",act2.fields("72").value,"center"  'ARANCEL %
	genera_html "d",act2.fields("73").value,"center"  'ARANCEL PREFERENCIAL 
	genera_html "d",retornaECI(act2.fields("29").value,"E",mid(act2.fields("29").value,1,3), oConex),"center"  ' MONTO DE RECUPERACION $  
   '-----
...
'Lote 1
 ...
 '  genera_html "d",act2.fields("781").value,"center"  ' IVA FRACC. $ 
   ...
   genera_html "d",sumaTotalImpuestos(act2.fields("29").value,mid(act2.fields("29").value,1,3),oConex)& "Falta dividirle T.C.","center"  ' Total Impuestos USD 
	...
	genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"DEMORAS"),"E",mid(act2.fields("29").value,1,3),oConex),"center"  ' DEMORAS 
	genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"ESTADIAS"),"E",mid(act2.fields("29").value,1,3),oConex),"center"  ' ESTADIAS 
	 
	 if ucase(mid(act2.fields("29").value,1,3)) ="RKU" then
	 genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"MANIOBRAS"),"E",mid(act2.fields("29").value,1,3),oConex),"center"  ' MANIOBRAS  
 	 genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"ALMACENAJES-MANIOBRAS"),"E",mid(act2.fields("29").value,1,3),oConex),"center"  ' ALMACENAJES 
	else
 	 genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"ALMACENAJES-MANIOBRAS"),"E",mid(act2.fields("29").value,1,3),oConex),"center"  ' MANIOBRAS
	 genera_html "d","?","center"  ' ALMACENAJES 
	end if
	

	'genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"OTROS"),"E",mid(act2.fields("29").value,1,3),oConex),"center"  ' OTROS 
	...
	ALMAN=0
	MAN=0
	TPH=CDbl(retornaTOTALPagosHechos(act2.fields("29").value,"E",mid(act2.fields("29").value,1,3),oConex))
	DEM= CDbl (retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"DEMORAS"),"E",mid(act2.fields("29").value,1,3),oConex))
	EST = CDbl (retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"ESTADIAS"),"E",mid(act2.fields("29").value,1,3),oConex))
	ALMAN= CDbl (retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"ALMACENAJES-MANIOBRAS"),"E",mid(act2.fields("29").value,1,3),oConex))
	
	if ucase(mid(act2.fields("29").value,1,3)) ="RKU" then
	  MAN= CDbl (retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"MANIOBRAS"),"E",mid(act2.fields("29").value,1,3),oConex))
	end if
	...
	if(revisaImpuestosFacturados( act2.fields("29").value,"E",mid(act2.fields("29").value,1,3), oConex) <> 0 )then
...
'end if
	...
	'genera_html "d",retornaTOTALPagosHechos(act2.fields("29").value,"E",mid(act2.fields("29").value,1,3),oConex)-sumaTotalImpuestos(act2.fields("29").value,mid(act2.fields("29").value,1,3))-sumaTotalIVA(act2.fields("29").value,mid(act2.fields("29").value,1,3)),"center"  ' TOTAL GASTOS DIVERSOS 
	genera_html "d",retornaTOTALPagosHechos(act2.fields("29").value,"E",mid(act2.fields("29").value,1,3),oConex)-STIMP-STIVA,"center"  ' TOTAL GASTOS DIVERSOS 

...
'http://10.66.1.5/portalmysql/extranet/ext-asp/reportes/reporte_extracostos_booklet_Frac.asp?finicio=01/01/2012&ffinal=31/01/2012&tipope=i&det=
'02/02/2012 Ivan Juarez
'http://10.66.1.9/portalmysql/extranet/ext-asp/reportes/reporte_extracostos_expo_booklet_Frac.asp?finicio=01/01/2012&ffinal=31/01/2012&tipope=e&det=
'Response.Write("Hola Mundo")
'Response.End()
Response.Buffer = TRUE
response.Charset = "utf-8"
Response.Addheader "Content-Disposition", "attachment; filename=Booklet_Extracostos_Expo.xls"'
...
"  '' as 'Item05' , i.firmae01 as 'firmita',  " & _
...
"           left join rku_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and i.adusec01 = fr.adusec02 and i.patent01 = fr.patent02   " & _
...
"    where cc.rfccli18 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255','URE711115AX5') and i.firmae01 is not null and i.firmae01 <> '' " & _
						 " and i.firmae01 is not null and  cta.fech31 >=  '"& finicio &"' and cta.fech31 <= '"& ffinal &"' " & _
" group by i.refcia01,f.numfac39,fr.fraarn02,fr.ordfra02 " & _
" union all " & _
" select  " & _
" i.refcia01,fr.fraarn02,fr.ordfra02, " & _
" i.cvecli01 as '1', " & _
...
"           left join dai_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and i.adusec01 = fr.adusec02 and i.patent01 = fr.patent02   " & _
...
"           left join sap_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and i.adusec01 = fr.adusec02 and i.patent01 = fr.patent02   " & _
...
"           left join tol_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and i.adusec01 = fr.adusec02 and i.patent01 = fr.patent02   " & _
...
"           left join ceg_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and i.adusec01 = fr.adusec02 and i.patent01 = fr.patent02   " & _
...
"           left join lzr_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and i.adusec01 = fr.adusec02 and i.patent01 = fr.patent02   " & _
...
"    where cc.rfccli18 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255','URE711115AX5') and i.firmae01 is not null and i.firmae01 <> '' " & _
						 " and i.firmae01 is not null and  cta.fech31 >=  '"& finicio &"' and cta.fech31 <= '"& ffinal &"' " & _
" group by i.refcia01,f.numfac39,fr.fraarn02,fr.ordfra02 "
...
'response.end()
	...
	while not act2.eof
		...
		genera_html "d","MEX","center"  'País de Procedencia
		...
		if (ref <> refAux)then
		 ...
		 'Lote 2
			...
			contass=contass+1
			'94
			'if(contass=95 or contass=132) Then
			...
			'Else
				...
				genera_html "d","0","center"  ' TOTAL GASTOS DIVERSOS USD 			
			
			'End If
				'response.write(TPH &"---"& DEM &"---"& EST&"---"& ALMAN &"--"& MAN &"-------"&contass&"Trmina " &act2.fields("29").value&"--->>")
				'response.write (STIMP&"--->>")
				'response.write (STIVA)
...
"  left join "& oficina &"_extranet.d31refer as r on r.refe31 = i.refcia01  " & _
"     left join "& oficina &"_extranet.e31cgast as cta on cta.cgas31 = r.cgas31 " & _
"          left join "& oficina &"_extranet.d21paghe as dp on dp.refe21 = i.refcia01 and dp.cgas21 = r.cgas31 " & _
"             left join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S'   and ep.tmov21 =dp.tmov21 " & _
"                  left join  "& oficina &"_extranet.c21paghe as cp on cp.clav21 = ep.conc21 " & _
...
dim c,valor
 ...
 " left join  "&oficina&"_extranet.d31refer as r on cta.cgas31 = r.cgas31 " & _
...
sqlAct =" select  c.import36 as Campo ,c.cveimp36,c.refcia36  from "& oficina &"_extranet.ssdag"& tipope &"01 as i " & _
		"  left  join  "& oficina &"_extranet.sscont36 as c on i.refcia01 = c.refcia36 " & _
		"    where c.refcia36 = '"& referencia &"' and c.cveimp36 = '18' and i.rfccli01 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255','URE711115AX5')"
...
'		" left join "& oficina &"_extranet.d21paghe as dp on dp.refe21 = i.refcia01 " & _
'		" left join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and ep.fech21 = dp.fech21 and ep.conc21 in ("&conceptos&") and ep.esta21 <> 'S' and ep.esta21 <> 'C' " & _
'		" where i.rfccli01 in ('CME8909276S1') and i.refcia01 = '"&referencia&"'  and i.firmae01 <> ''   group by i.refcia01 "
...
"             left join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S'  and ep.tmov21 =dp.tmov21 " & _
"                  left join  "& oficina &"_extranet.c21paghe as cp on cp.clav21 = ep.conc21 " & _
"    where  i.rfccli01 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255','URE711115AX5')  and i.firmae01 <> ''  and cta.esta31 <> 'C'  and ep.conc21 in ("&conceptos&") and i.refcia01 = '"&referencia&"'  group by Ref,cgas31,conc21"
...
' sqlAct =" select i.refcia01 as Ref,sum(dp.mont21*if(ep.deha21 = 'C',-1,1)) as Importe " & _
		...
		' " left join "& oficina &"_extranet.d21paghe as dp on dp.refe21 = i.refcia01 " & _
		' " left join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.tmov21 =dp.tmov21 " & _
		' " where i.rfccli01 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255','URE711115AX5')  and i.refcia01 = '"&referencia&"'  and i.firmae01 <> ''  group by i.refcia01 "
...
sqlAct="select Distinct count(*) as campo from  "&oficina&"_extranet.sscont40 where refcia40 = '"&referencia&"'  "

...
'http://10.66.1.9/portalmysql/extranet/ext-asp/reportes/_unilever-idot-142012.asp?finicio=14/01/2012&ffinal=25/01/2012&tipope=i&det=
...
"    where cc.rfccli18 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255') and i.firmae01 is not null and i.firmae01 <> ''  and  i.fecpag01 >=  '"& finicio &"' and i.fecpag01 <= '"& ffinal &"' " & _
...
"			 left join dai_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr2.fraarn02  and fr2.ordfra02 = ar2.agru05   " & _
...
"    where cc.rfccli18 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255') and i.firmae01 is not null and i.firmae01 <> ''  and   i.fecpag01 >=  '"& finicio &"' and i.fecpag01 <= '"& ffinal &"' " & _ 
" group by i.refcia01,ar.fact05,ar.item05,fr.fraarn02,fr.ordfra02,ar.pfac05 " & _
" union all " & _
" select   " & _

...
if(strTipoOperaciones=1 And nTxt=1) Then
	codex= genera_registros("ENC","IMPO",finicio,ffinal)
		
	With Response
	  .Charset = "UTF-8"
	  .Clear
	  .ContentType = "text/plain"
	  .AddHeader "Content-Disposition","attachment; filename=ReporteBroseOper.txt"
...
if(strTipoOperaciones=2 And nTxt=1) Then
	codex= genera_registros("DET","IMPO",finicio,ffinal)		
	With Response
	  .Charset = "UTF-8"
	  .Clear
	  .ContentType = "text/plain"
	  .AddHeader "Content-Disposition","attachment; filename=ReporteBroseFacturas.txt"
	  .AddHeader "Content-Length", Len(codex)
	  .Write codex
	  .Flush
	  .End
...
DIM XML : XML = "<?xml version='1.0'?>" & _
  ...
  .AddHeader "Content-Disposition","attachment; filename=ReporteBroseOper.xls"
...
DIM XML2 : XML2 = "<?xml version='1.0'?>" & _ 
  ...
  .Clear
  .ContentType = "excel/ms-excel"
  .AddHeader "Content-Disposition","attachment; filename=ReporteBroseFacturas.xls"
...
"   where cc.rfccli18 = 'BPU991217FV6' and i.firmae01 is not null  and i.firmae01 <> '' and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"' " & _
" group by importa " & _
" union all  " & _
...
"   where cc.rfccli18 = 'BPU991217FV6'  and i.firmae01 is not null and i.firmae01 <> ''   " & _
...
"                 left join tol_extranet.ssipar12 as ipar2 on ipar2.refcia12 = i.refcia01 and ipar2.ordfra12 = fr.ordfra02 and ipar2.cveide12 in ('PS','TG','PS','TL','OC') " & _
"   where cc.rfccli18 = 'BPU991217FV6' and i.firmae01 is not null  and i.firmae01 <> ''   and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"'"

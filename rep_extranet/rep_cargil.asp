...
<BODY>
	...
	item=""
	lista=" and a.pedi01 in ( "
    if strReferencia<>"" then
		arreglo=split(strReferencia,",")
		
		for i=0 to ubound(arreglo)
			lista=lista & "'" & arreglo(i) & "'"
			if i<ubound(arreglo) then
				lista=lista & ","			
			end if
   ...
   <%''''''''''''''''''''''''if  Session("GUsuario") <> "" then
	...
	%>
            ...
            if not REFE.eof then 'if 3
				if strFiltroCliente = 4583 then
					While (NOT  REFE.EOF)
						referencia = REFE("ref")
								  ...
								  %>
									<table width="854" border="1" cellspacing="3" cellpadding="3">
										  ...
										  <tr bgcolor="#C0C0C0" >
											 ...
											 <td width="50px" ><font size="1" color="#000000" > <b> FOLIO TICKET        </b> </FONT></th> <!-- Ticket -->
											 <td width="50px" ><font size="1" color="#000000" > <b> FECHA PAGO PEDIMENTO      </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> FECHA REAL          </b> </FONT></th> <!-- Fecha Ticket -->
											 ...
											 <td width="50px" ><font size="1" color="#000000" > <b> TRANSPORTE          </b> </FONT></th> <!-- Tipo de Vehiculo -->
											 <td width="50px" ><font size="1" color="#000000" > <b> PLACA CAMION        </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> PLACAS TANQUE       </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> PLACA CARROTANQUE   </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> NOMBRE CHOFER       </b> </FONT></th> <!-- Tipo de Vehiculo -->
											 <td width="50px" ><font size="1" color="#000000" > <b> TANQUE VOPAK        </b> </FONT></th> <!-- Tipo de Vehiculo -->
											 <td width="50px" ><font size="1" color="#000000" > <b> SELLO DE EMBARQUE   </b> </FONT></th>
											 <!-- <td width="50px" ><font size="1" color="#000000" > <b> CANDADOS   			</b> </FONT></th> -->
											 <td width="50px" ><font size="1" color="#000000" > <b> No. DE PEDIMENTO    </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> BARCO               </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> PRODUCTO            </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> PROVEEDOR             </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> ADUANA   			</b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> DESTINO/CLIENTE   			</b> </FONT></th>
										  </tr>

								  <% '************************************partidas tce**********************
								'	Response.Write ("contador " + trim(cstr(formatnumber(intcontadorunidades,0))) )
						saldolib = 0
						Set Connx = Server.CreateObject ("ADODB.Connection")
						Set RSPart = Server.CreateObject ("ADODB.RecordSet")
						Connx.Open MM_EXTRANET_STRING2
						...
						strSQL= " SELECT a.refe01 as ref,        " &_
										  ...
										  "        c.ticket ,              " &_
										  "        c.fectick,              " &_
										  "        if(c.tipveh <> 'R',placas,'S/N') placas ,              " &_
										  "        if(c.tipveh = 'R',placas,'S/N') placasct ,   " &_
										  "		   c.transpor, 			   " &_
										  "        c.placaJau,             " &_
										  "        c.pesoBruto pesoBruto,           " &_
										  "        c.pesoTara pesoTara,             " &_
										  "        c.pesoNeto pesoNeto,             " &_
										  "        c.operador,             " &_
										  ...
										  "		   c.transpor, 			   " &_
										  "        c.placaJau2,             " &_
										  "        c.pesoBruto2 pesoBruto,           " &_
										  "        c.pesoTara2 pesoTara,             " &_
										  "        c.pesoNeto2 pesoNeto,             " &_
										  "        c.operador,             " &_
										  "        TIME_FORMAT(c.horaPes,'%H:%i') as horaPes, " &_
										  "        c.destino,              " &_
										  "        c.FecDoc,               " &_
										  ...
										  "   and pesoaudita > 0  " & _
										  "   and c.TipVeh = 'R'  " &_
										  "   and (c.nload2 <> '' or c.ticket2 <> '' or c.placaJau2 <> '' or sellos2 <> '' or c.pesoBruto2 <>0 or c.pesoTara2 <> 0 or c.pesoNeto2 <> 0)  " &_
										  "   order by consec  "
									'Response.write(strSQL)
						Set RSPart= Connx.Execute(strSQL)
						'Response.write(RSPart)
						Do while not RSPart.Eof
							...
							strplacasct  = RSPart("placasct")
							strtranspor  = RSPart("transpor")
							strplacaJau  = RSPart("placaJau")
							strpesoBruto = RSPart("pesoBruto")'/1000
							strpesoTara  = RSPart("pesoTara")'/1000
							strpesoNeto  = RSPart("pesoNeto")'/1000
							...
							strCandados   = RSPart("cdo")
							strFechaPago   = RSPart("fecpag01")
								...
								case "R"
									  ...
									  %>
									   <tr>
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write("S/N")   %>  </font></td><!-- No. LOAD      -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strticket)  %>  </font></td><!-- FOLIO TICKET     -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strFechaPago) %>  </font></td><!-- FECHA REAL  ahora FACHA PAGO PEDIMENTO  -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strfectick) %>  </font></td><!-- FECHA REAL    -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write( trim(cstr(strpesoBruto)) )%> </font></td><!-- P. BRUTO      -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write( trim(cstr(strpesoTara))  )%> </font></td><!-- P. TARA       -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write( trim(cstr(strpesoNeto))  )%> </font></td><!-- P. NETO       -->
										 <td align="Center"><font size="1" color="#000000" > <%RESPONSE.Write(strtranspor)  %>  </FONT></td><!-- TRANSPORTE          -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strplacas)  %>  </font></td><!-- PLACA CAMION -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strplacaJau)%>  </font></td><!-- PLACA TANQUE   -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strplacasct)%>  </font></td><!-- PLACA CARROTANQUE   -->
										 <td ><font size="1" color="#000000" > <%RESPONSE.Write(stroperador)%>   </font></td><!-- CONDUCTOR TRANSPORTE          -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strnload)%>  </font></td><!-- TANQUE VOPAK   -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strsellos)  %>  </font></td><!-- SELLO EMBARQUE -->
										 
										 <!-- candados -->
										 
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(trim(patente)&"-"&trim(pedimento)) %>  </font></td><!-- 	PEDIMENTO  -->
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strrecinto) %>  </font></td><!-- CLIENTE ahora PROVEEDOR-->
										 <td><font size="1" color="#000000" > VERACRUZ  </font></td><!-- CANDADOS ahora ADUANA -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strdestino) %>  </font></td><!-- CLIENTE ahora PROVEEDOR-->
								...
								case "R"
									  ...
									  %>
									   <tr>
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strCandados )  %>  </font></td><!-- CANDADOS -->
									   </tr>
								  ...
								  %>
                                    <table border="1" cellspacing="3" cellpadding="3">
                                          <tr bgcolor="#000000" >
											 ...
											 <!-- <td width="50px"><font size="1" color="#FFFFFF" > <b> CANDADOS  		</b> </FONT></td> -->
                            ...
                            saldolib=saldolib+round(pesoneto)
									  ...
									  %>
                                       <tr>
                                         ...
                                         <td ><font size="1" color="#000000" > <%if strFiltroCliente = 4583 then RESPONSE.Write(trim(cstr(strpesoTara))) else RESPONSE.Write( trim(cstr(formatnumber(strpesoTara,3)))) end if%> </font></td><!-- P.TARA  -->
                                         <td ><font size="1" color="#000000" > <%if strFiltroCliente = 4583 then RESPONSE.Write(trim(cstr(strpesoBruto))) else RESPONSE.Write(trim(cstr(formatnumber(strpesoBruto,3)))) end if%> </font></td><!-- P.BRUTO -->
                                         <td ><font size="1" color="#000000" > <%if strFiltroCliente = 4583 then RESPONSE.Write(trim(cstr(strpesoNeto))) else RESPONSE.Write(trim(cstr(formatnumber(strpesoNeto,3))))%> </font></td><!-- P. NETO -->
                                         ...
                                         <td ><font size="1" color="#000000" > <%RESPONSE.Write(strsellose)%>   </font></td><!-- SELLO ESLINGA    -->
										 <td ><font size="1" color="#000000" > <%RESPONSE.Write(strCandados)%>    </font></td>
                                       </tr>
		...
		<% 
				...
				'se inicia la opcion concentrado
				
			if  strTipoTransp = "3" and strFiltroCliente = 4583 then
					StrfilTipVeh = " AND TIPVEH IN ('H','K','C','T','l','J','F','G','P','D','R') "
					'response.write("seleccionaste la opcion concentrado")
		%>
				<!-- inicio de la tabla contenedora-->
				<table width="778"  border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center">
					...
					'comienzan las consultas para camiones
					...
					STRSQL= " SELECT distinct a.refe01 as ref,     " &_
                        ...
                        "      tcepartidas c                   " &_
                        " where a.refe01=b.refe01 "&permi&"    " &_
                        "   and b.refe01=c.refe01 " & strFilTipoFecha3 &_
                        "   and consec01 > 0            " &_
                        "   and partComp = 0            " & StrfilTipVeh & _
                        "   and pesoaudita > 0  "
		...
		%>		
			...
			<!-- el encabezado -->
				...
				<%
					tamano=0
					if not REFE.eof then 'si trae datos
						While (NOT  REFE.EOF) 'mientras el recorset no este en eof
							referencia = REFE("ref")
							QRYCIERRE = "SELECT DATE_ADD(fectick, INTERVAL 59 DAY) as feccierre, consec01 from tcepartidas where consec01 = 1 and refe01 = '" & referencia & "'"
							Set CIERRA = Server.CreateObject ("ADODB.RecordSet")
							SET CIERRA= Conn.Execute(QRYCIERRE)
				...
				<!-- los encabezados de las tablas de datos -->
						...
						<BR>
							   ...
							   <BR>
				<!-- se termina los encabezados de las tablas de datos -->
			
					<%
						' se mueve al siguien registro
							REFE.MoveNext  ' de las partidas de tce
							tamano=tamano+1
						wend ' se termina el bucle
					%>	
					...
					<%
							...
							strSQL= " SELECT a.refe01 as ref,        " &_
										  ...
										  "        c.candados as cdo,       " &_										 
										  "        TIME_FORMAT(c.horaDoc,'%H:%i') as horaDoc,  " &_
										  "        c.PlacaJau2 , c.sellos2 , c.Ticket2 , c.PesoTara2 , c.PesoBruto2 , c.PesoNeto2 " & _
										  " FROM pedimentos a,fracciones b,tcepartidas c " &_
										  " where a.refe01='"&referencia&"'  " &_
										  "   and a.refe01=b.refe01         " &_
										  "   and a.refe01=c.refe01         " & strFilTipoFecha3 &permi &_
							...
							Do while not RSPart.Eof
								...
								strPlacaJau2   = RSPart("PlacaJau2")
								strSellos2   = RSPart("sellos2")
								strTicket2   = RSPart("Ticket2")
								strPesoTara2   = RSPart("PesoTara2")
								strPesoBruto2   = RSPart("PesoBruto2")
								strPesoNeto2   = RSPart("PesoNeto2")
								...
								if tipoveh="R" or tipoveh="l" then
									for i=0 to 1
										if i=1 then										
								%>		
										...
										<tr>
									     <td><font size="1" color="#000000" > <%RESPONSE.Write(strConsec)   %>  </font></td><!-- CONSECUTIVO      -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write("S/N")   %>  </font></td><!-- No. LOAD      -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strTicket2)  %>  </font></td><!-- FOLIO TICKET     -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strFechaPago) %>  </font></td><!-- FECHA REAL  ahora FACHA PAGO PEDIMENTO  -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strfectick) %>  </font></td><!-- FECHA REAL    -->
										 
										 <td><font size="1" color="#000000" > <%if strFiltroCliente = 4583 then RESPONSE.Write(trim(cstr(strPesoBruto2))) else RESPONSE.Write(trim(cstr(formatnumber(strPesoBruto2,3)))) end if%> </font></td><!-- P. BRUTO      -->
										 <td><font size="1" color="#000000" > <%if strFiltroCliente = 4583 then RESPONSE.Write(trim(cstr(strPesoTara2))) else RESPONSE.Write(trim(cstr(formatnumber(strPesoTara2,3)))) end if%> </font></td><!-- P. TARA       -->
										 <td><font size="1" color="#000000" > <%if strFiltroCliente = 4583 then RESPONSE.Write(trim(cstr(strPesoNeto2))) else RESPONSE.Write(trim(cstr(formatnumber(strPesoNeto2,3)))) end if%> </font></td><!-- P. NETO       -->
										 
										 <td align="Center"><font size="1" color="#000000" > <%RESPONSE.Write(strtranspor)  %>  </FONT></td><!-- TRANSPORTE          -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strplacas)  %>  </font></td><!-- PLACA CAMION -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strPlacaJau2)%>  </font></td><!-- PLACA TANQUE   -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strplacasct)%>  </font></td><!-- PLACA CARROTANQUE   -->
										 <td ><font size="1" color="#000000" > <%RESPONSE.Write(stroperador)%>   </font></td><!-- CONDUCTOR TRANSPORTE          -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strnload)%>  </font></td><!-- TANQUE VOPAK   -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strSellos2)  %>  </font></td><!-- SELLO EMBARQUE -->
								...
								<tr>
									...
									<td>
									  <font size="1" color="#000000" >
										...
										<% RESPONSE.Write( trim(cstr(formatnumber(arreglo(i),0))) ) %>
							   ...
							   <tr>
									...
									<td>
									  <font size="1" color="#000000" >
										...
										<% RESPONSE.Write( trim(cstr(formatnumber(arreglo(i),3))) ) %>
					...
					%>
								...
								<tr>
                                    ...
                                    <td>
                                      <font size="1" color="#000000" >
                                        <% RESPONSE.Write( trim(cstr(formatnumber(arreglo2(i),0))) ) %>
                                      </font>
                                    </td>
                               </tr>
                               <%
                               ...
                               <tr>
                                    ...
                                    <td>
                                      <font size="1" color="#000000" >
                                        <% RESPONSE.Write( trim(cstr(formatnumber(arreglo2(i),3))) ) %>
                                      </font>
                                    </td>
                               </tr>
					...
					%>
						...
						%>
							<table>
								<tr>
									<th colspan=12>
									<font size="2" face="Arial">No se Encontro ningun registro con esos parametros1</font>
									</th>
								</tr>
							</table>
					...
					<table>
						<tr>
							<th colspan=12>
							<font size="2" face="Arial">No se Encontro ningun registro con esos parametros2</font>
							</th>
						</tr>
					</table>
		...
		<%
				else 'si no selecciona concentrado ni el cliente es 4583	
					if  strTipoTransp = "4" then
						StrfilTipVeh = " AND TIPVEH IN ('H','K','C','T','l','J','F','G','P','D','R') "
						...
						if not REFE.eof then
							While (NOT  REFE.EOF)
								...
								StrRnombar   = REFE("Rnombar")
										  ...
										  %>
											<table width="854" border="1" >
												  ...
												  <tr bgcolor="#000000" >
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> LOAD            </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> FOLIO TICKET        </b> </FONT></th> <!-- Ticket -->
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> FECHA PAGO PEDIMENTO      </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> FECHA REAL EMBARQUE          </b> </FONT></th> <!-- Fecha Ticket -->
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PESO BRUTO(KG)         </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PESO TARA(KG)          </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PESO NETO(KG)          </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> TRANSPORTE          </b> </FONT></th> <!-- Tipo de Vehiculo -->
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PLACA CAMION        </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PLACAS TANQUE       </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PLACA CARROTANQUE   </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> NOMBRE CHOFER       </b> </FONT></th> <!-- Tipo de Vehiculo -->
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> TANQUE VOPAK        </b> </FONT></th> <!-- Tipo de Vehiculo -->
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> SELLO DE EMBARQUE   </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> No. DE PEDIMENTO    </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> BARCO               </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PRODUCTO            </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> PROVEEDOR             </b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> ADUANA   			</b> </FONT></th>
													 <td width="50px" ><font size="1" color="#FFFFFF" > <b> DESTINO   			</b> </FONT></th>
												  </tr>
								...
								strSQL= " SELECT a.refe01 as ref,        " &_
												  ...
												  "        c.destino,              " &_
												  "        c.FecDoc,               " &_
												  "        (select i.nompro01 from rku_extranet.ssdagi01 i where i.refcia01 ='"&referencia&"') as Recinto," &_
												  "        c.sellos as se,         " &_
												  "        c.sellosE as see,       " &_
												  "        c.candados as cdo,       " &_										 
												  "        TIME_FORMAT(c.horaDoc,'%H:%i') as horaDoc  " &_
								...
								Do while not RSPart.Eof
									...
									strTanqueVopak     = RSPart("TanqueVopak")
									strticket    = RSPart("ticket")
									strfectick   = RSPart("fectick")
									strplacas    = RSPart("placas")
									strplacasct  = RSPart("placasct")
									...
									strFechaPago   = RSPart("fecpag01")
									   ...
									   <tr>
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strplacasct)%>  </font></td><!-- PLACA CARROTANQUE   -->
										 <td ><font size="1" color="#000000" > <%RESPONSE.Write(stroperador)%>   </font></td><!-- CONDUCTOR TRANSPORTE          -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strTanqueVopak)%>  </font></td><!-- TANQUE VOPAK   -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strsellos)  %>  </font></td><!-- SELLO EMBARQUE -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(trim(patente)&"-"&trim(pedimento)) %>  </font></td><!-- 	PEDIMENTO  -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(StrRnombar) %>   </font></td><!-- BARCO -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(Strrmercan) %>  </font></td><!-- PRODUCTO -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strrecinto) %>  </font></td><!-- CLIENTE ahora PROVEEDOR-->
										 <td><font size="1" color="#000000" > VERACRUZ  </font></td><!-- ADUANA -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write(strdestino) %>  </font></td><!-- DESTINO -->
										</tr>
							...
							wend 'REFErencia
								...
								<table>
								  <tr>
									<th colspan=12>
									  <font size="2" face="Arial">No se Encontro ningun registro con esos parametros nu</font>
									</th>
								  </tr>
								</table>
		...
		%>	
						...
						<table>
							<tr>
								<th colspan=12>
								<font size="2" face="Arial">No se Encontro ningun registro con esos parametros3</font>
								</th>
							</tr>
						</table>

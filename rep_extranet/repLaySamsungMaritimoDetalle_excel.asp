...
<%
    ...
    Response.Addheader "Content-Disposition", "attachment;filename=TRACKING_MARITIMO.xls"
                                       ...
                                       '*********************************************
                                             ...
                                             While NOT RMercancias.EOF
                                                 ...
                                                 '***************************************************************************
                                                     ...
                                                     'StrPPORT_OF_LOADING   = RsRep.Fields.Item("PORT_LOADING").Value
                                                     '         &","&RsRep.Fields.Item("VESSEL_LOADING").Value
                                                     'StrPPORT_OF_LOADING   = RsRep.Fields.Item("PORT_LOADING").Value&","&RsRep.Fields.Item("VESSEL_LOADING").Value 'PORT OF LOADING
...
<%
    ...
    function DespliegaEncabezado()
       ...
       strHTML = strHTML & "<strong><font color=""#969696"" size=""3"" face=""Arial, Helvetica, sans-serif""> TRACKING MARITIMO DETALLE MERCANCIAS" & " </font></strong>"

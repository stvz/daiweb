...
"   where cc.rfccli18 = 'BDM571004IZ6' and i.firmae01 is not null  and i.firmae01 <> '' and cveped01 in ('IN', 'AF', 'RT') and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"' " & _
" group by importa " & _
" union all  " & _
...
"   where cc.rfccli18 = 'BDM571004IZ6'  and i.firmae01 is not null and i.firmae01 <> ''  and cveped01 in ('IN', 'AF', 'RT') " & _
...
"                 left join lzr_extranet.ssipar12 as ipar2 on ipar2.refcia12 = i.refcia01 and ipar2.ordfra12 = fr.ordfra02 and ipar2.cveide12 in ('PS','TG','PS','TL','OC') " & _
"   where cc.rfccli18 = 'BDM571004IZ6' and i.firmae01 is not null  and i.firmae01 <> ''  and cveped01 in ('IN', 'AF', 'RT')  and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"'"
...
conn12 = "DRIVER={MySQL ODBC 5.1 Driver}; SERVER=localhost; DATABASE="&oficina&"_extranet; UID=EXTRANET; PWD=rku_admin; OPTION=16427"

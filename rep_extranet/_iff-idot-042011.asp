...
'http://10.66.1.9/portalmysql/extranet/ext-asp/reportes/_unilever-idot-042011.asp?finicio=14/01/2012&ffinal=25/01/2012&tipope=i&det=
...
<%
sqlAct= "select  " & _
" i.refcia01,fr2.fraarn02,fr2.ordfra02, " & _
" i.cvecli01 as '1', " & _
" 'unilever'  as '2',  " & _
" 'unilever'  as '3', " & _
" ar.desc05 as '4', " & _
...
" '?'as '80', fr2.ordfra02 as '810', count(fr2.ordfra02) as '820', " & _
...
"         left join rku_extranet.d05artic as ar2 on ar2.refe05 = i.refcia01 " & _
"           left join rku_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and ar.frac05 = fr.fraarn02  and fr.ordfra02 = ar.agru05   " & _
"			 left join rku_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr.fraarn02  and fr.ordfra02 = ar2.agru05   " & _
...
"    where cc.rfccli18 in ('IFF610526PQ6','IF&610526C95') and i.firmae01 is not null and i.firmae01 <> ''  and  i.fecpag01 >=  '"& finicio &"' and i.fecpag01 <= '"& ffinal &"' " & _
...
"			 left join dai_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr.fraarn02  and fr.ordfra02 = ar2.agru05   " & _
"             left join dai_extranet.ssprov22 as prv on prv.cvepro22 = i.cvepro01   " & _
"               left join dai_extranet.ssumed31 as um on um.clavem31 = fr2.u_medc02   " & _
...
"    where cc.rfccli18 in ('IFF610526PQ6','IF&610526C95') and i.firmae01 is not null and i.firmae01 <> ''  and   i.fecpag01 >=  '"& finicio &"' and i.fecpag01 <= '"& ffinal &"' " & _ 
" group by i.refcia01,ar2.fact05,ar2.item05,fr2.fraarn02,fr2.ordfra02,ar2.pfac05 " & _
" union all " & _
" select   " & _
...
"         left join sap_extranet.d05artic as ar2 on ar2.refe05 = i.refcia01 " & _
"           left join sap_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and ar.frac05 = fr.fraarn02  and fr.ordfra02 = ar.agru05   " & _
"			 left join sap_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr.fraarn02  and fr.ordfra02 = ar2.agru05   " & _
...
"         left join tol_extranet.d05artic as ar2 on ar2.refe05 = i.refcia01 " & _
"           left join tol_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and ar.frac05 = fr.fraarn02  and fr.ordfra02 = ar.agru05   " & _
"			 left join tol_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr.fraarn02  and fr.ordfra02 = ar2.agru05   " & _
...
"         left join ceg_extranet.d05artic as ar2 on ar2.refe05 = i.refcia01 " & _
"           left join ceg_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and ar.frac05 = fr.fraarn02  and fr.ordfra02 = ar.agru05   " & _
"			 left join ceg_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr.fraarn02  and fr.ordfra02 = ar2.agru05   " & _
...
"			 left join lzr_extranet.ssfrac02 as fr2 on i.refcia01 = fr2.refcia02  and ar2.frac05 = fr.fraarn02  and fr.ordfra02 = ar2.agru05   " & _
...
'response.end()
	...
	while not act2.eof
		...
		genera_html "d",act2.fields("ffac05").value,"center"  'Fecha de Factura G1
		genera_html "d",retornaIMPORTADOR(act2.fields("21").value,mid(act2.fields("29").value,1,3)),"center"  'IMPORTADOR
...
sqlAct =" select c.import36 as Campo ,c.cveimp36,c.refcia36  from "& oficina &"_extranet.ssdag"& tipope &"01 as i " & _
		...
		"    where c.refcia36 = '"& referencia &"' and c.cveimp36 = '18' and i.rfccli01 in ('IFF610526PQ6','IF&610526C95')"
...
'		" where i.rfccli01 in ('IFF610526PQ6','IF&610526C95') and i.refcia01 = '"&referencia&"'  and i.firmae01 <> ''   group by i.refcia01 "
...
"             inner join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.esta21 <> 'C'  and ep.tmov21 =dp.tmov21 " & _
"                  inner join  "& oficina &"_extranet.c21paghe as cp on cp.clav21 = ep.conc21 " & _
"    where  i.rfccli01 in ('IFF610526PQ6','IF&610526C95')  and i.firmae01 <> ''  and cta.esta31 <> 'C'  and ep.conc21 in ("&conceptos&") and i.refcia01 = '"&referencia&"'  group by Ref,cgas31,conc21"

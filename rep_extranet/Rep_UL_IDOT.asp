...
<td height=52 class=xl28 id="_x0000_s1025" x:autofilter="all"
  x:autofilterrange="$A$1:$DA$800" width=125 style='height:39.0pt;width:94pt'
			...
			Subref = act2.fields("Ord FrcA").value
				if (ordenOcupado(Subref,act2.fields("Refe").value) = False)then
					...
					if (act2.fields("cveped").value<>"G1") then
						...
						genera_html "d",retornaECI(act2.fields("Refe").value,"I",mid(act2.fields("Refe").value,1,3)),"center"  ' MONTO DE RECUPERACION $  
	       ...
	       if oficina = "RKU" then
		       ...
		       if oficina = "DAI" then
			           if topico = "ALMACENAJES" then
						...
						if topico = "MANIOBRAS" then
						 cad="127,82,102,35,6,11,3,141,63,315,219"
						end if
						if topico="CONEXION REFRIGERADO" then 	
						cad="60"
					end if
...
sqlAct =" select c.import36 as Campo ,c.cveimp36,c.refcia36  from "& oficina &"_extranet.ssdag"& tipope &"01 as i " & _
		...
		"    where c.refcia36 = '"& referencia &"' and c.cveimp36 = '18' and i.rfccli01 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255')"
...
condicion=" AND con.numcon40 = REPLACE(REPLACE(d01.marc01, '/', ''), '-', '') "
else 
condicion=""
end if
...
"  i.refcia01 as 'Refe',    "&_
 ...
 "fr2.ordfra02 as '810',"&_
  ...
  "LEFT join "&Oficina2&"_extranet.e31cgast as cta on cta.cgas31 = ctar.cgas31  and cta.esta31 <> 'C'     "&_
            ...
            "left join "&Oficina2&"_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  and ar.frac05 = fr.fraarn02  and fr.ordfra02 = ar.agru05      "&_
              ...
              "left join "&Oficina2&"_extranet.ssprov22 as prv on prv.cvepro22 = i.cvepro01      "&_
                "left join "&Oficina2&"_extranet.ssumed31 as um on um.clavem31 = ar2.umco05       "&_
                     "left join "&Oficina2&"_extranet.sscont36 as cf1 on cf1.refcia36 = i.refcia01 and cf1.cveimp36 = '1'      "&_
                     "left join "&Oficina2&"_extranet.sscont36 as cf3 on cf3.refcia36 = i.refcia01 and cf3.cveimp36 = '3'      "&_
                     "left join "&Oficina2&"_extranet.sscont36 as cf6 on cf6.refcia36 = i.refcia01 and cf6.cveimp36 = '6'      "&_
                     "left join "&Oficina2&"_extranet.sscont36 as cf15 on cf15.refcia36 = i.refcia01 and cf15.cveimp36 = '15'      "&_
	...
	if Oficina<>"dai2" then					 
     sqlAct=sqlAct & "where cc.rfccli18 in ('UME651115N48','BRM711115GI8','ISI011214HM3','UMA011214255') and i.firmae01 is not null and i.firmae01 <> '' and i.cveped01<>'G1'and  i.fecpag01 >='"&fechaini&"' and i.fecpag01 <= '"&fechafin&"'  /*and i.fecpag01>'2013-05-12'*/ "&_

...
'http://10.66.1.9/portalmysql/extranet/ext-asp/reportes/_unilever-expo.asp?finicio=23/12/2011&ffinal=13/01/2012&tipope=i&det=

Response.Buffer = TRUE
response.Charset = "utf-8"
Response.Addheader "Content-Disposition", "attachment; filename=UNI_EXPO.xls"'
...
<td height=52 class=xl28 id="_x0000_s1025" x:autofilter="all"
  ...
  style='width:75pt'>DOMICILIO FISCAL</td>
...
'response.end()
	...
	while not act2.eof
		...
		genera_html "d",act2.fields("dfiscal").value,"center"  'DOMICILIO FISCAL
		...
		if (ref <> refAux)then
		 ...
		 'Lote 2
			...
			'-----
				...
				genera_html "d",retornaECI(act2.fields("29").value,"E",mid(act2.fields("29").value,1,3)),"center"  ' MONTO DE RECUPERACION $  
		...
		genera_html "d",retornaTipoUnidad(act2.fields("29").value,"e",mid(act2.fields("29").value,1,3)),"center" 'TIPO UNIDAD
...
" from "& oficina &"_extranet.ssdage01 as i  " & _
...
sqlAct =" select c.import36 as Campo ,c.cveimp36,c.refcia36  from "& oficina &"_extranet.ssdage01 as i " & _
...
sqlAct=" SELECT tracto01 as campo from "& oficina &"_extranet.ssdage01 AS i LEFT JOIN "& oficina &"_extranet.sscont40 " & _

...
'********************************************************************************
        ...
        'MExico
        'MEX
'        permi = PermisoClientes( "MEX",strPermisos,"cvecli01")
'        permi2 = PermisoClientesTabla("B","MEX" ,strPermisos,"clie31")
'        MM_EXTRANET_STRING = ODBC_POR_ADUANA( "MEX" )

        'response.write("<br><br>permi=")
        'response.write(permi)
        'response.write("<br>perm2=")
        'response.write(permi2)
        'response.write("<br>MM_EXTRANET_STRING=")
        'response.write(MM_EXTRANET_STRING)


        'Manzanillo
        'MAN
'        permi = PermisoClientes( "MAN",strPermisos,"cvecli01")
'        permi2 = PermisoClientesTabla("B","MAN" ,strPermisos,"clie31")
'        MM_EXTRANET_STRING = ODBC_POR_ADUANA( "MAN" )
        ...
        'Lazaro
        'LZR
'        permi = PermisoClientes("LZR",strPermisos,"cvecli01")
'        permi2 = PermisoClientesTabla("B","LZR" ,strPermisos,"clie31")
'        MM_EXTRANET_STRING = ODBC_POR_ADUANA( "LZR" )
  ...
  ' Response.Write(MM_EXTRANET_STRING)
  ' response.end
  ' MM_EXTRANET_STRING = "DRIVER={MySQL ODBC 3.51 Driver}; SERVER=10.66.1.5; DATABASE=rku_extranet; UID=EXTRANET; PWD=rku_admin; OPTION=16427"
...
function buscareg(strSQLP)

            if not trim(strSQLP)="" then
                Set RsRep = Server.CreateObject("ADODB.Recordset")
                ...
                if not RsRep.eof then
                   ...
                   'Response.Write(strSQLP)
                    ...
                    While NOT RsRep.EOF
                          ...
                          Set RsRep1 = Server.CreateObject("ADODB.Recordset")
                          MM_EXTRANET_STRING_TEMP = MM_EXTRANET_STRING
                          MM_EXTRANET_STRING      = ODBC_POR_ADUANA( "CEG" )

                          permi2temp = permi2
                          permi2 = PermisoClientesTabla("B","CEG" ,strPermisos,"clie31")
                          ...
                          MM_EXTRANET_STRING = MM_EXTRANET_STRING_TEMP
                          permi2 = permi2temp
...
function confAduana(aduana)

        strPermisos = Request.Form("Permisos")
        permi = PermisoClientes(aduana,strPermisos,"cvecli01")
        permi2 = PermisoClientesTabla("B",aduana ,strPermisos,"clie31")
        MM_EXTRANET_STRING = ODBC_POR_ADUANA( aduana )
...
Function encabezado()
     ...
     strHTML = strHTML & "<strong><font color=""#000066"" size=""3"" face=""Arial, Helvetica, sans-serif""><p>REPORTE DE DESGLOSADO MULTIOFICINAS DE " & tmpTipo & " </p></font></strong>"
...
End Function
        ...
        'permi = PermisoClientes("VER",strPermisos,"cvecli01")
        'permi2 = PermisoClientesTabla("B","VER" ,strPermisos,"clie31")
        ...
        'permi = PermisoClientes("TAM" ,strPermisos,"cvecli01")
        'permi2 = PermisoClientesTabla("B","TAM" ,strPermisos,"clie31")
        'MM_EXTRANET_STRING = ODBC_POR_ADUANA( "TAM" )

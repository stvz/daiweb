...
<%
' Modificado por Manuel Alejandro Estevez Fernandez
' Marzo 2013
function get_pedimento_sir()
...
''	  " and  c.esta31<>'C' and d.fech11<='"&DateF&"'  group by referencia " 
  ...
  sql1= "Select r.refe31 as referencia" &_
        " ,c.fech31 as FechaCG,c.clie31 as CVECLIENTE, c.CGAS31 AS cg, c.chon31 as HONORARIOS," &_
        "     c.SUPH31 AS PH, c.csce31 as SC,c.anti31 as ANTICIPO, c.sald31 as Saldo, c.tota31 as TOTAL #," &_
        ...
        ", c.frec31 " &_
        "      FROM d31refer as r " &_
        "      join e31cgast as c using(cgas31)" &_
        "      left join D11MOVIM AS d on  d.cgas11 = r.cgas31  " &_
        "      left join E11Movim AS e ON d.Foli11 = e.Foli11 " &_
        "      where d.fech11<='"&DateF&"' and d.ccli11 in " &cvecliente2& " group by cg" 

'" Select i.refcia01 as referencia,c.fech31 as FechaCG,c.clie31 as CVECLIENTE, c.CGAS31 AS cg, c.chon31 as HONORARIOS, " &_
''      " c.SUPH31 AS PH, c.csce31 as SC,c.anti31 as ANTICIPO, c.sald31 as Saldo, c.tota31 as TOTAL, " &_
''	  " trim(concat(concat(concat(concat(concat(i.adusec01),'-'),i.patent01),'-'),i.numped01)) as pedimento, " &_
''	  " ref.fdsp01 as fechadespacho,i.nomcli01,i.numped01, i.fecpag01,'Importacion' as Tipoper, c.frec31  " &_
...
''	  " trim(concat(concat(concat(concat(concat(ex.adusec01),'-'),ex.patent01),'-'),ex.numped01)) as pedimento, " &_
	  '" ref.fdsp01 as fechadespacho,ex.nomcli01,ex.numped01, ex.fecpag01,'Exportacion' as Tipoper, c.frec31  " &_
...
'	  " and  c.esta31<>'C' and d.fech11<='"&DateF&"' " & permi & "  group by referencia " 
   ...
   sql1= "Select r.refe31 as referencia" &_
        ...
        "      left join D11MOVIM AS d on  d.cgas11 = r.cgas31  " &_
        "      left join E11Movim AS e ON d.Foli11 = e.Foli11 " &_
        " where  d.fech11<='"&DateF&"'  " & permi & " and d.ccli11="&strFiltroCliente&" group by cg " 
...
<strong><font color="#000066" size="3" face="Arial, Helvetica, sans-serif"><p>Estado de Cuenta Al <%=DateF%></p></font></strong>
   ...
   <tr>
	   ...
	   <td bgcolor="#006699" ><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><b>FECHA DE EMISION</b></FONT></td>
	   ...
	   <td bgcolor="#006699" ><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><b>NOTA DE CARGO</b></FONT></td>
       ...
       <td bgcolor="#006699" ><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><b>F. DE RECEPCION</b></FONT></td>
	   <td bgcolor="#006699" ><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><b>F. SALDO</b></FONT></td>
	 ...
	 <%
		  ...
		  isaldos=0
		   ...
		   ntotal4=0
          if not REFE.eof then 
          ' Definiendo los objetos de conexion a la base de datos deo SIR'
          ...
          '/******************************************* Busca datos del pedimento en el SIR
          datos_referencia_ = "select ref_.sRazonSocialCliente " & _
              ", ref_.sPedimento " & _
              ", ref_.adusec " & _
              ", ref_.Patente " & _
              ", ref_.[Tipo Operacion] " & _
              ", ref_.dFechaPago " & _
              ", ref_.sReferencia " & _
              ", cli_.sClave " & _
              ", cli_.sRFC " & _
            "from sir.dbo.GSI_VT_Referencias ref_ " & _
            "join sir.Admin.ADMINC_07_CLIENTES cli_ on ref_.nIdClie07 = cli_.nIdClie07 " & _
            "where cli_.sRFC= '"&  &"' " & _
            "and ref_.sReferencia = '"&REFE("referencia")&"' " 
...
'*********************************para las notas de credito************************************		 
        ...
        if  (ban_gastos_sca=1 or ban_gastos_scr=1) then
          ...
          Set rsliq = Server.CreateObject ("ADODB.RecordSet")
          Conx.Open MM_EXTRANET_STRING
	      SQLx=" SELECT mont11,DATE_FORMAT(fech11, '%d/%m/%Y') as fech11,foli11,refe11,conc11 FROM e31cgast a,d11movim b " &_
		  " where a.cgas31='"&cg&"' and a.cgas31=b.refe11 and (conc11='SCA' or conc11='SCR') and fech11<='"&DateF&"' "
	      Set rsliq= Conx.Execute(SQLx)
          'response.Write(sqlx)
          'response.end
		  Do while not rsliq.Eof
		     ...
		     if num_nota = 1 then
				...
				fecha_nota = fecha_nota & ", " & rsliq("fech11")
			 end if
		     gto_nota = gto_nota + rsliq("mont11")
...
'			 end if 
       ...
       ''cn=cn+1
		 ...
		 <tr>
			 ...
			 <td align="center"><font size="-1"><%RESPONSE.Write(gastos_SinNotas+gto_nota)%></font></td>

...
'response.write( request.Form("txtCliente"))
'response.write(request.Form("ckcve"))
	...
	Else
		...
		Do Until RSops.EOF
				...
				datos = datos &	"<tr>" &_
								...
								celdadatos(Contenedor(RSops.Fields.Item("Referencia").Value)) &_
								celdadatos(RSops.Fields.Item("Oficina").Value) &_
								celdadatos(RSops.Fields.Item("Causal").Value) &_
								celdadatos(ObservaLib(RSops.Fields.Item("Referencia").Value)) &_

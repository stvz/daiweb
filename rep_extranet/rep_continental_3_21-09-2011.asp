        ...
        Do while not RsD05art.Eof
                    ...
                    if strvalfacfra > 0 then
						...
						End If
                                 ...
                                 sqlpermisos= " select cveide12 as TipoTasa, " &_
                                              ...
                                              " comide12  "&_
                                              " from ssipar12 " &_
                                              " where refcia12='"&REFE("refcia01")&"' and ordfra12= "&RsD05art("agru05")&" "&_
                                              " group by cveide12"
            ...
            '***********************************
                  ...
                  sqL= " select refcia39," & _
                       ...
                       "        terfac39," & _
                       "        monfac39," & _
                       "        IF( fecfac39>'1900-00-00',fecfac39,'0000-00-00') as fecfac39, " & _
                       "        valdls39," & _
                       "        valmex39," & _
                       "        cvepro39," &_
                       "        vincul39," & _
            ...
            '*****************************DATOS FILAS*****************************
                ...
                -->
                 <tr>
                     ...
                     <td align="center"><font size="-1"><%RESPONSE.Write(formatofechaNum(fechafac)) %>   </font></td> <!-- Fecha Factura -->

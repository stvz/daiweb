...
if strTipoPedimento  = "1" then
   ...
   strSQL = " SELECT tipopr01, " & _
            ...
            "        numped01  " & _
            " FROM ssdagi01 " & _
            " WHERE fecpag01 >='" & FormatoFechaInv(strDateIni) & "' " & _
            "       AND fecpag01 <='" & FormatoFechaInv(strDateFin) & "' " & _
                    Permi & " and firmae01 !='' " & _
            "   order by refcia01 "
end if
if strTipoPedimento  = "2" then
   tmpTipo = "EXPORTACION"
   strSQL = "SELECT tipopr01, factmo01, p_dta101, t_reca01, i_dta101, cvecli01, refcia01, fecpag01, valfac01, fletes01, segros01, cvepvc01, " &_
			"tipcam01, patent01, numped01, totbul01, cveped01, cveadu01, desf0101, nompro01, cvepod01, nombar01, tipopr01, fecpre01 " &_
			"FROM ssdage01 WHERE fecpag01 >='"&FormatoFechaInv(strDateIni)&"' AND fecpag01 <='"&FormatoFechaInv(strDateFin)&"' " & Permi & " and firmae01 !='' order by refcia01"
end if
...
'Sus parametros son
      ...
      'Aqui se obtienen las fracciones por referencia
			strSQL2="select ordfra02,fraarn02,d_mer102,cancom02,cancom02,u_medc02,cantar02,u_medt02,vmerme02,vaduan02,tasadv02,p_adv102,i_adv102,i_iva102,i_adv102,i_adv202,i_cc0102,i_cc0202 from ssfrac02 where refcia02='"&pRefer&"'"

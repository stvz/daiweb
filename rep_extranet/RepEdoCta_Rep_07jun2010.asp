...
sql1= " Select i.refcia01 as referencia,c.fech31 as FechaCG,c.clie31 as CVECLIENTE, c.CGAS31 AS cg, c.chon31 as HONORARIOS, " &_
	  ...
	  " ref.fdsp01 as fechadespacho,i.nomcli01,i.numped01, i.fecpag01 " &_
      ...
      " inner join D11MOVIM AS d on  d.cgas11 = r.cgas31 and d.ccli11 = cli.cvecli18  " &_
      " inner join E11Movim AS e ON d.Foli11 = e.Foli11 " &_ 
      " where i.rfccli01='"&Vrfc&"' and i.firmae01<> '' and i.firmae01 <> '' " &_
	  " and c.esta31='I' and c.esta31<>'C' and d.fech11<='"&DateF&"'  group by cg " &_
	  " union all " &_
	  ...
	  " ref.fdsp01 as fechadespacho,ex.nomcli01,ex.numped01, ex.fecpag01 " &_
      ...
      " inner join D11MOVIM AS d on  d.cgas11 = r.cgas31 and d.ccli11 = cli.cvecli18  " &_
      " inner join E11Movim AS e ON d.Foli11 = e.Foli11 " &_ 
      " where ex.rfccli01='"&Vrfc&"' and ex.firmae01<> '' and ex.firmae01 <> '' " &_
	  " and c.esta31='I' and c.esta31<>'C' and d.fech11<='"&DateF&"'  group by cg " 
''	
...
'	  " and  c.esta31<>'C' and d.fech11<='"&DateF&"' " & permi & "  group by referencia " 
  ...
  sql1= " Select i.refcia01 as referencia,c.fech31 as FechaCG,c.clie31 as CVECLIENTE, c.CGAS31 AS cg, c.chon31 as HONORARIOS, " &_
      ...
      " inner join D11MOVIM AS d on  d.cgas11 = r.cgas31 and d.ccli11 = cli.cvecli18  " &_
      " inner join E11Movim AS e ON d.Foli11 = e.Foli11 " &_ 
      " where i.firmae01<> '' and i.firmae01 <> '' " &_
	  " and c.esta31='I' and c.esta31<>'C' and d.fech11<='"&DateF&"'  " & permi & " group by cg " &_
	  " union all " &_
	  " Select ex.refcia01 as referencia,c.fech31 as FechaCG,c.clie31 as CVECLIENTE, c.CGAS31 AS cg, c.chon31 as HONORARIOS, " &_
      " c.SUPH31 AS PH, c.csce31 as SC,c.anti31 as ANTICIPO, c.sald31 as Saldo, c.tota31 as TOTAL, " &_
	  " trim(concat(concat(concat(concat(concat(ex.adusec01),'-'),ex.patent01),'-'),ex.numped01)) as pedimento, " &_
      ...
      " inner join D11MOVIM AS d on  d.cgas11 = r.cgas31 and d.ccli11 = cli.cvecli18  " &_
      " inner join E11Movim AS e ON d.Foli11 = e.Foli11 " &_ 
      " where ex.firmae01<> '' and ex.firmae01 <> '' " &_
	  " and c.esta31='I' and c.esta31<>'C' and d.fech11<='"&DateF&"' " & permi & "  group by cg " 

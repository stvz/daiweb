								  ...
								  %>
									<table width="854" border="1" cellspacing="3" cellpadding="3">
										  ...
										  <tr bgcolor="#C0C0C0" >
											 ...
											 <td width="50px" ><font size="1" color="#000000" > <b> P.BRUTO(TM)         </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> P.TARA(TM)          </b> </FONT></th>
											 <td width="50px" ><font size="1" color="#000000" > <b> P.NETO(TM)          </b> </FONT></th>
								  ...
								  Do while not RSPart.Eof
									  ...
									  %>
									   <tr>
										 ...
										 <td><font size="1" color="#000000" > <%RESPONSE.Write( trim(cstr(formatnumber(strpesoBruto,3))) )%> </font></td><!-- P. BRUTO      -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write( trim(cstr(formatnumber(strpesoTara,3)))  )%> </font></td><!-- P. TARA       -->
										 <td><font size="1" color="#000000" > <%RESPONSE.Write( trim(cstr(formatnumber(strpesoNeto,3)))  )%> </font></td><!-- P. NETO       -->

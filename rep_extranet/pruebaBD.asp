...
'http://10.66.1.9/PortalMySQL/Extranet/ext-Asp/Reportes/valeoPrueba.asp?finicio=27/04/2011&ffinal=16/05/2011&tipope=i&det=
...
'mes=Request.QueryString("mes")
 ...
 'nTxt = request.Form("rbnTipoForm")

 strTipoOperaciones= 2
 nTxt=2
 fechaini="01/05/2011"
 fechafin="31/05/2011"
 
 '1,1 Para Encabezados.txt (Importación y Exportación)
 '1,2 Para Encabezados.xls (Importación y Exportación)
 '2,1 Para Detalles.txt (Importación y Exportación)9999999
 '2,2 Para Detalles.xls (Importación y Exportación)9999999
...
%>
<title> Reporte BROSE</title>
</head>
<body>

<%

if(strTipoOperaciones=1 And nTxt=1) Then
	codex= genera_registros("ENC","EXPO",finicio,ffinal)
		
	With Response
	  .Charset = "UTF-8"
	  .Clear
	  .ContentType = "text/plain"
	  .AddHeader "Content-Disposition","attachment; filename=EncabezadoEXPO.txt"
	  .AddHeader "Content-Length", Len(codex)
	  .Write codex
	  .Flush
	  .End
	End With		
...
if(strTipoOperaciones=2 And nTxt=1) Then
	codex= genera_registros("DET","EXPO",finicio,ffinal)		
	With Response
	  .Charset = "UTF-8"
	  .Clear
	  .ContentType = "text/plain"
	  .AddHeader "Content-Disposition","attachment; filename=FacturasIMPO.txt"
	  .AddHeader "Content-Length", Len(codex)
	  .Write codex
	  .Flush
	  .End
...
if(strTipoOperaciones=1 And nTxt=2) Then
...
DIM XML : XML = "<?xml version='1.0'?>" & _
              "<?mso-application progid='Excel.Sheet'?>" & _
               ...
               "    <Author>Jorge Lorenzana</Author>" & _
               "    <LastAuthor>Jorge Lorenzana</LastAuthor>" & _
               ...
               "        <Borders/>" & _
               "        <Font ss:FontName='Calibri' x:Family='Swiss' ss:Size='9' ss:Color='#000000'/>" & _
               "        <Interior/>" & _
               "        <NumberFormat/>" & _
               "        <Protection/>" & _			   
               "    </Style>" & _
			   ...
			   "  <Font ss:FontName='Calibri' x:Family='Swiss' ss:Size='10' ss:Color='#FFFFFF' ss:Bold='1'/>" & _
			   "  </Style> " & _
               "</Styles>" & _
  ...
  .AddHeader "Content-Disposition","attachment; filename=EncabezadoEXPO.xls"
 ...
 if(strTipoOperaciones=2 And nTxt=2) Then
DIM XML2 : XML2 = "<?xml version='1.0'?>" & _ 
              "<?mso-application progid='Excel.Sheet'?>" & _
               "<Workbook xmlns='urn:schemas-microsoft-com:office:spreadsheet' " & _
               " xmlns:o='urn:schemas-microsoft-com:office:office' "& _
               " xmlns:x='urn:schemas-microsoft-com:office:excel' " & _
  ...
  .Clear
  .ContentType = "excel/ms-excel"
  .AddHeader "Content-Disposition","attachment; filename=FacturasEXPO.xls"
  .AddHeader "Content-Length", Len(XML2)
  .Write XML2
  .Flush
  .End
 End With
...
codigo = ""
 ...
 codigo=codigo &"<Row>"
 'cod= cod & " <tr align="&c&"center"&c&" bordercolor="&c&"#999999"&c&" bgcolor="&c&"#FFFFFF"&c&"> "
 ...
 'genera_html "e","Nota_Interna","center"
 genera_html "e","Prev","center"
 codigo=codigo &"</Row>"
 
'cod= cod & chr(13) & chr(10)
...
" if(i.tipped01=1,'N','S') as Consolidado,'' as Virtual,cf2.import36 as Prev,Replace(Replace(i.anexol01,'\r',''),'\n','') as Observaciones " & _
...
"   where cc.rfccli18 = 'BDM571004IZ6' and i.firmae01 is not null  and i.firmae01 <> '' and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"' " & _
" group by importa " & _
" union all  " & _
...
"        inner join tol_extranet.ssfrac02 as fr on i.refcia01 = fr.refcia02  " & _
"              left join tol_extranet.sscont36 as cf2 on cf2.refcia36 = i.refcia01 and cf2.cveimp36 = '15'  " & _
"                 left join tol_extranet.sscont36 as cf3 on cf3.refcia36 = i.refcia01 and cf3.cveimp36 = '1'  " & _
"   where cc.rfccli18 = 'BDM571004IZ6' and i.firmae01 is not null  and i.firmae01 <> '' and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"'" & _
" group by importa  " 
 ...
 genera_html "e","JustTLCAN","center"
 genera_html "e","JustTLCUEM","center"
 genera_html "e","JustTLCAELC","center"
...
" f.numfac39 as Factura, prv.nompro22 as CodigoP, date_format(f.fecfac39,'%d/%m/%Y') as FechaFac,i.factmo01 as FMoneda,ar.item05 as Numparte, replace(replace(ar.desc05,'\n',''),'\r','') as DscNP, " & _
...
" 1 as Conversion,i.cvepod01 as Origen,i.cvepvc01 as Vendedor,ifnull(cf4.fpagoi36,0) as Fpago, f.terfac39 as Incoterm , if(concat(ipar2.cveide12,ipar.comide12)='TLEMU','UE',if(concat(ipar2.cveide12,ipar.comide12)='TLCAN','AN',if(concat(ipar2.cveide12,ipar.comide12)='TLUSA','US',concat(ipar2.cveide12,ipar.comide12)))) as AcuerdoCom, " & _
...
"   where cc.rfccli18 = 'BDM571004IZ6'  and i.firmae01 is not null and i.firmae01 <> ''   " & _
...
"   from tol_extranet.ssdagi01 as i " & _
"      inner join tol_extranet.ssclie18 as cc on cc.cvecli18 = i.cvecli01 " & _
"       left join tol_extranet.ssfact39 as f on f.refcia39 = i.refcia01   " & _
"         left join tol_extranet.d05artic as ar on ar.refe05 = i.refcia01 and f.numfac39 = ar.fact05  " & _
...
"                left join tol_extranet.sscont36 as cf4 on cf4.refcia36 = i.refcia01 and cf4.cveimp36 = '6'  " & _
"                  left join tol_extranet.ssipar12 as ipar on ipar.refcia12 = i.refcia01 and ipar.ordfra12 = fr.ordfra02 and ipar.cveide12 = 'TL' and ipar.comide12 in ('CAN','USA','EMU','NOR','CHE','ISL','LIE') " & _
"                  left join tol_extranet.ssipar12 as ipar2 on ipar2.refcia12 = i.refcia01 and ipar2.ordfra12 = fr.ordfra02 and ipar2.cveide12 in ('PS','TG','PS','TL','OC') " & _
"   where cc.rfccli18 = 'BDM571004IZ6'  and i.firmae01 is not null and i.firmae01 <> ''  " & _
...
" i.adusec01 as Aduanas, date_format(i.fecpag01,'%d/%m/%Y') as Fecha,i.tipcam01 as TipoCambio,ifnull(sum(fr.I_iva102 + fr.I_iva202),0) as IVA,i.cveped01 as Clave,  " & _
" ifnull(i.fletes01,0) as Fletes,  ifnull(i.segros01,0) as Seguros, ifnull(i.embala01,0) as Embalaje,ifnull(i.incble01,0) as Otros,ifnull(i.i_dta101,0) as DTA,cf3.import36 as DTA2,sum(fr.prepag02) as ValorCom,(i.tipcam01*i.valfac01) as ValorComBAD,sum(fr.vaduan02) as ValorAd,Replace(Replace(i.anexol01,'\r',''),'\n','') as Observaciones, " & _
" if(i.tipped01=1,'N','S') as Consolidado,'' as Virtual,cf2.import36 as Prev " & _
...
" f.numfac39 as Factura, prv.nompro22 as CodigoC, date_format(f.fecfac39,'%d/%m/%Y') as FechaFac,i.factmo01 as FMoneda,ar.item05 as Numparte, replace(replace(ar.desc05,'\n',''),'\r','') as DscNP, " & _
...
" 1 as Conversion,i.cvepod01 as Destino,i.cvepvc01 as Comprador,ifnull(cf4.fpagoi36,0) as Fpago, f.terfac39 as Incoterm,fr.ordfra02,ar.agru05  " & _
"   from rku_extranet.ssdage01 as i " & _
"    inner join rku_extranet.ssclie18 as cc on cc.cvecli18 = i.cvecli01 " & _
"      left join rku_extranet.ssfact39 as f on f.refcia39 = i.refcia01   " & _
"       left join rku_extranet.d05artic as ar on ar.refe05 = i.refcia01 and f.numfac39 = ar.fact05  " & _
...
"            left join tol_extranet.ssumed31 as um on um.clavem31 = fr.u_medc02  " & _
"              left join tol_extranet.sscont36 as cf4 on cf4.refcia36 = i.refcia01 and cf4.cveimp36 = '6'  " & _
"                left join tol_extranet.ssipar12 as ipar on ipar.refcia12 = i.refcia01 and ipar.ordfra12 = fr.ordfra02 and ipar.cveide12 = 'TL'  " & _
"                 left join tol_extranet.ssipar12 as ipar2 on ipar2.refcia12 = i.refcia01 and ipar2.ordfra12 = fr.ordfra02 and ipar2.cveide12 in ('PS','TG','PS','TL','OC') " & _
"   where cc.rfccli18 = 'BDM571004IZ6' and i.firmae01 is not null  and i.firmae01 <> ''   and i.fecpag01 >='"&finicio&"' and i.fecpag01 <= '"&ffinal&"'"
...
'cod= cod & chr(13) & chr(10)
		 codigo=codigo &"<Row>"
			...
			' if(existeNumeroParte(mid(act2.fields("referencia").value,1,3),act2.fields("referencia").value,act2.fields("Numparte").value)=true)then
			  ...
			  ' nparte = codigoProducto(act2.fields("Numparte").value)
...
sub genera_html(tipo,valor,alineacion)
 ...
 if(tipo = "e")then
  'cod= cod & "<td width="&c&"100"&c&" align="&c&alineacion&c&" nowrap bgcolor="&c&"#CCFF99"&c&"><div align="&c&alineacion&c&"><strong><em><font size="&c&"2"&c&" face="&c&"Verdana, Arial, Helvetica, sans-serif"&c&">"&valor&";</font></em></strong></div></td>"
  codigo = codigo&"<Cell ss:StyleID='s21'><Data ss:Type='String'>"&valor&"</Data></Cell>" 
  'cod= cod & Trim(valor)  &";"
 End If
 if(tipo = "d")then
  'cod= cod & "<td align="&c&alineacion&c&" nowrap><div align="&c&alineacion&c&"><font color="&c&"#000000"&c&" size="&c&"1"&c&" face="&c&"Verdana, Arial, Helvetica, sans-serif"&c&">"&valor&";</font></div></td>"
...
function codigoProducto(desc)
dim res,desc2
res = "no"
Path=Server.MapPath("catmatbd.xls")
'desc2=replace(desc," ","%")
Set ConexionBD = Server.CreateObject("ADODB.Connection") 
ConexionBD.Open "DRIVER={Microsoft Excel Driver (*.xls)};DBQ=" & Path
Set rsVac = Server.CreateObject("ADODB.Recordset") 
rsVac.Open "Select * From A1:B140 where NumPart like '" & desc & "'", ConexionBD,3,3 

if not(rsVac.eof)then
 res =rsVac.fields("NumPart") '&","&rsVac.fields("descpro")
else
 res = "(error) "& desc
end if 

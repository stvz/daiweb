...
if nueva then
 ...
 genera_html "d",RSops.Fields.Item("Valor Aduana").Value,"right"
  ...
  genera_html "d",RSops.Fields.Item("ValorAd").Value,"right"
 genera_html "d",RSops.Fields.Item("Observaciones").Value,"center"
 genera_html "d",RSops.Fields.Item("Consolidado").Value,"center"
 genera_html "d",RSops.Fields.Item("Virtual").Value,"center"
  genera_html "d",RSops.Fields.Item("Prev").Value,"right"

...
'																												'
' 
'Reporte estados de cuenta COMPLETO
'http://10.66.1.9/portalmysql/extranet/ext-asp/reportes/unilever-estados-CC-112011-RSG.asp?finicio=16/11/2011&ffinal=24/11/2011&tipope=i&det=
...
<!-- Genera Encabezados -->
  ...
  style='width:75pt'>Descripción de las Mercancías</td>
  
  <td class=xl33 id="_x0000_s1056" x:autofilter="all" width=100
  style='width:75pt'>Contenedores</td>
  
  <td class=xl33 id="_x0000_s1056" x:autofilter="all" width=100
  style='width:75pt'>Total de Bultos</td>

  <td class=xl54 id="_x0000_s1081" x:autofilter="all" width=100
  style='width:75pt' x:str="Peso/Kg"><span
  style='mso-spacerun:yes'> </span>Peso/Kg<span
  style='mso-spacerun:yes'> </span></td>

   <td class=xl60 id="_x0000_s1108" x:autofilter="all" width=100
  style='width:75pt' x:str="Fecha de Despacho"><span
  style='mso-spacerun:yes'> </span>Fecha de Despacho<span
  style='mso-spacerun:yes'> </span></td>
  
  <td class=xl61 id="_x0000_s1109" x:autofilter="all" width=100
  style='width:75pt' x:str="Cuenta de Gastos"><span
  style='mso-spacerun:yes'> </span>Cuenta de Gastos<span
  style='mso-spacerun:yes'> </span></td>
  
    <td class=xl61 id="_x0000_s1109" x:autofilter="all" width=100
  style='width:75pt' x:str="Fecha de la C.G."><span
  style='mso-spacerun:yes'> </span>Fecha de la C.G.<span
  style='mso-spacerun:yes'> </span></td>
  
    
	<td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Honorarios</td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Servicios Complementarios</td>

  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Maniobras</td>

  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Flete marítimos</td>

  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Consolidación y revalidación/td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Flete Terrestre</td>

  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Almacenaje</td>

  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Demoras</td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Reparación de contenedor </td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Limpieza de contenedor </td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Retiro de Etiquetas</td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Reacomodo de contenedor</td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Reconocimiento aduanero</td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Estadias de Transporte</td>
  
  <td class=xl37 id="_x0000_s1044" x:autofilter="all" width=100
  style='width:75pt'>Total</td>
...
"	i.cveped01 as 'cvepedi', " & _
"   rec.pedorg06 as 'pedo', " & _
"  rec.reforg06 as 'refeo', " & _
" i.pesobr01 as '231' " & _
"   from rku_extranet.ssdag"&tipope&"01 as i  " & _
...
"                    left join rku_extranet.ssipar12 as ipar2 on ipar2.refcia12 = i.refcia01 and ipar2.ordfra12 = fr.ordfra02 " & _
"                    left join rku_extranet.ssmtra30  as transp on transp.clavet30 = i.cvemts01    " & _
"    where cc.rfccli18 in ('CCE520101TC7','JMA100111B2A') and i.firmae01 is not null" & _
"    and i.firmae01 <> '' and  cta.fech31 >=  '"& finicio &"' and cta.fech31 <= '"& ffinal &"' " & _ 
" group by i.refcia01,f.numfac39"
...
'response.end()
	...
	while not act2.eof
		...
		genera_html "d","","center"  'Consecutivo
		
		rcli =act2.fields("11").value
						

		genera_html "d",act2.fields("29").value,"center"  'Referencia
		
		if tipope = "i" then
		genera_html "d","Importación","center"  'Tipo de operación
		else
		genera_html "d","Exportación","center" 
		
		genera_html "d",act2.fields("31").value,"center"  'No. De Pedimento
		
		genera_html "d",act2.fields("4").value,"center"  'Mercancías
		...
		Else
		genera_html "d","","center"  'Contenedores
		...
		genera_html "d",act2.fields("42").value,"center" 'Fecha de despacho
		...
		if (ref <> refAux)then
			...
			genera_html "d",retornaPagosHechos(act2.fields("29").value,retornaConceptosPH(mid(act2.fields("29").value,1,3),"FLETES"),"E",mid(act2.fields("29").value,1,3)),"center"  ' Servicios complementarios
			...
			if ucase(mid(act2.fields("29").value,1,3)) ="RKU" or ucase(mid(act2.fields("29").value,1,3)) ="SAP" then
				...
				genera_html "d","0","center"  ' ALMACENAJES 
			end if
...
sqlAct =" select i.refcia01 as Ref,ifnull(sum(dp.mont21*if(ep.deha21 = 'C',-1,1)),0) as Importe " & _
		" from "& oficina &"_extranet.ssdag"&tipope&"01 as i  " & _
		" LEFT JOIN "& oficina &"_extranet.d31refer AS ctar ON ctar.refe31 = i.refcia01 " & _
		" LEFT JOIN "& oficina &"_extranet.e31cgast AS cta ON cta.cgas31 = ctar.cgas31  " & _
		" inner join "& oficina &"_extranet.d21paghe as dp on dp.refe21 = i.refcia01 and dp.cgas21 = cta.cgas31 " & _
		" inner join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.tmov21 =dp.tmov21 " & _
		" where i.rfccli01 in ('UME651115N48','BRM711115GI8','ISI011214HM3')  and i.refcia01 = '"&referencia&"'  and i.firmae01 <> ''  group by i.refcia01 "

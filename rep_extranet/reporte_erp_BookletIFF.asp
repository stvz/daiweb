...
Response.Addheader "Content-Disposition", "attachment; filename=BookletIGUAZU.xls"
...
validacion=""
 ...
 fechaini = "01/06/2010" 'trim(request.Form("txtDateIni"))
 fechafin = "30/06/2010" 'trim(request.Form("txtDateFin"))
 strTipoOperaciones = "e" 'request.Form("rbnTipoDate")

'oficina=Request.QueryString("ofi")
tipope=Request.QueryString("tipope")
det=Request.QueryString("det")
mes=Request.QueryString("mes")
'finicio=Request.QueryString("finicio")
'ffinal=Request.QueryString("ffinal")
...
"   from rku_extranet.ssdag"& strTipoOperaciones &"01 as i  " & _
...
"  ar.item05 as 'Item05' , i.firmae01 as 'firmita',  " & _
"  transp.descri30  as 'sDescTransp'  " & _
"   from dai_extranet.ssdag"& strTipoOperaciones &"01 as i  " & _
...
"  ar.item05 as 'Item05' , i.firmae01 as 'firmita',  " & _
"  transp.descri30  as 'sDescTransp'  " & _
"   from sap_extranet.ssdag"& strTipoOperaciones &"01 as i  " & _
...
"  ar.item05 as 'Item05' , i.firmae01 as 'firmita',  " & _
"  transp.descri30  as 'sDescTransp'  " & _
"   from tol_extranet.ssdag"& strTipoOperaciones &"01 as i  " & _
...
"  ar.item05 as 'Item05' , i.firmae01 as 'firmita',  " & _
"  transp.descri30  as 'sDescTransp' " & _
"   from ceg_extranet.ssdag"& strTipoOperaciones &"01 as i  " & _
"   inner join ceg_extranet.ssclie18 as cc on cc.cvecli18 = i.cvecli01  " & _
...
"  ar.item05 as 'Item05' , i.firmae01 as 'firmita',  " & _
"  transp.descri30  as 'sDescTransp'  " & _
"   from lzr_extranet.ssdag"& strTipoOperaciones &"01 as i  " & _
...
'Lote 1
 ...
 '  genera_html "d",act2.fields("781").value,"center"  ' IVA FRACC. $ 
   ...
   genera_html "d",(sumaTotalImpuestos(act2.fields("29").value,mid(act2.fields("29").value,1,3))/act2.fields("65").value),"center"  ' Total Impuestos USD  
	...
	dim TPH,DEM,EST,ALMMAN,MAN,STIMP,STIVA
	TPH=0
	DEM=0
	EST=0
	ALMAN=0

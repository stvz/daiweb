...
'http://10.66.1.5/portalmysql/extranet/ext-asp/reportes/reporte_erp_unilever_99.asp?finicio=28/12/2010&ffinal=13/01/2011&tipope=i&det=
...
num=0
 ...
 'response.write( fechaini & "-----test-----" )
 'response.write( fechafin & "-----test-----" )
 'response.end()
...
' Response.Write("fecha inicio = " & fechaini & "<br>fecha final = " & fechafin & "<br>")
' Response.End

...
<%
   ...
   ' End Function
    ...
    function DespliegaEncabezado()
       ...
       strHTML = strHTML & "<strong><font color=""#969696"" size=""3"" face=""Arial, Helvetica, sans-serif""> TRACKING AEREO DETALLE MERCANCIAS " & " </font></strong>"
     ...
     '-------------------------------------------------------------------------------------------------------------------------------
    'Funcion para escribir el encabezado del reporte en la cadena HTML
    'function agregarfilaHTML(REFERENCIA, OTD2, GUIA_MASTER, GUIA_HOUSE, FORWARDER_AIR_LINE, AEROPUERTO_SALIDA, NOTIFICACION_GUIA,FECHA_NOTIFICACION, IMPORT_DOCUMENT, PROVEEDOR, INVOICE, MODEL, DESCRIPCION_COMERCIAL, DESCRIPTION_CODE, QTY, INCOTERMS, SERIAL_NUMBER,	ORIGIN_ETD, ETA_LAX, ATA_CUSTOM, RESQUEST_DUTIES, FECHA_DE_REVALIDACION, FECHA_DE_PREVIO, DATE_OF_CLEARANCE, ATA_WH, TIMEOFDELIVERY, REMARKS, WEEK, AMOUNTOFDUTIES, NUM_INVOICECUSTOM, DATEINVOICECUSTOM )
    'function agregarfilaHTML(COLOR,REFERENCIA, OTD2, GUIA_MASTER, GUIA_HOUSE,P_OA , FORWARDER_AIR_LINE, AEROPUERTO_SALIDA, CUSTOM_OF_DISPATCH, NOTIFICACION_GUIA,FECHA_NOTIFICACION, VESSEL, IMPORT_DOCUMENT, PROVEEDOR, INVOICE, MODEL, DESCRIPCION_COMERCIAL, DESCRIPTION_CODE, QTY, INCOTERMS, SERIAL_NUMBER,CERT_NOM,	ORIGIN_ETD, ETA_LAX, ATA_CUSTOM, RESQUEST_DUTIES, FECHA_DE_REVALIDACION, FECHA_DE_PREVIO, ETA_CUSTOM_CLEARANCE ,DATE_OF_CLEARANCE, ETA_C_P, ATA_CP ,ETA_W_H, ATA_WH, TIMEOFDELIVERY, REMARKS, MODALIDAD ,WEEK, AMOUNTOFDUTIES, NUM_INVOICECUSTOM, DATEINVOICECUSTOM )
    function agregarfilaHTML(COLOR,      REFERENCIA,      OTD2,     GUIA_MASTER,     GUIA_HOUSE   ,  P_OA ,   FORWARDER_AIR_LINE,     AEROPUERTO_SALIDA,     CUSTOM_OF_DISPATCH,    NOTIFICACION_GUIA,     FECHA_NOTIFICACION,     VESSEL,     IMPORT_DOCUMENT,     PROVEEDOR,     INVOICE,     MODEL,     DESCRIPCION_COMERCIAL,     DESCRIPTION_CODE,     QTY,     INCOTERMS,     SERIAL_NUMBER,     CERT_NOM,	    ORIGIN_ETD,     ETA_LAX,     ATA_CUSTOM,     RESQUEST_DUTIES,     FECHA_DE_REVALIDACION,     FECHA_DE_PREVIO,     ETA_CUSTOM_CLEARANCE ,    DATE_OF_CLEARANCE,     ETA_C_P,      ATA_CP ,    ETA_W_H,     ATA_WH,     TIMEOFDELIVERY,      REMARKS,     MODALIDAD ,     WEEK,     AMOUNTOFDUTIES,     NUM_INVOICECUSTOM,     DATEINVOICECUSTOM,     ADUDESPACHO, RMKATDORIGIN,    RMKATAPORT,    RMKDEPACHO,    RMKATDRAIL,    RMKCP,    ATASPL,    STATUS,    LASTRMK,    KPISTATUS )
       ...
       if COLOR <> 2 and COLOR <> 3 then
           ...
           '******************************************************
            ...
            '           strHTML = strHTML&"<td nowrap bgcolor='"&strColorNA&"'><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & "             " & " </font></td>" & chr(13) & chr(10) '32 REMARKS CLEARANCE
            '
       ...
       '    end if
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & AEROPUERTO_SALIDA	    & " </font></td>" & chr(13) & chr(10) 'AEROPUERTO DE SALIDA
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & CUSTOM_OF_DISPATCH    & " </font></td>" & chr(13) & chr(10) 'CUSTOM OF DISPATCH -- ADUANA SEGUN APENDICE 1 DEL ANEXO 22
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & FORWARDER_AIR_LINE    & " </font></td>" & chr(13) & chr(10) 'FORWARDER Y/O AIR  LINE
       '    strHTML = strHTML&"<td nowrap bgcolor='"&strColorNA&"'><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & "             " & " </font></td>" & chr(13) & chr(10) 'VESSEL
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & IMPORT_DOCUMENT	      & " </font></td>" & chr(13) & chr(10) 'IMPORT DOCUMENT
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & PROVEEDOR	            & " </font></td>" & chr(13) & chr(10) 'PROVEEDOR
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & INVOICE	              & " </font></td>" & chr(13) & chr(10) 'INVOICE
       '    strHTML = strHTML&"<td nowrap><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & DESCRIPTION_CODE	    & " </font></td>" & chr(13) & chr(10) 'DESCRIPTION CODE
       ...
       '      strHTML = strHTML&"<td nowrap><strong><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & FORWARDER_AIR_LINE    & " </font></strong></td>" & chr(13) & chr(10) 'FORWARDER Y/O AIR  LINE
       '      strHTML = strHTML&"<td nowrap bgcolor='"&strColorNA&"'><strong><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & "             " & " </font></strong></td>" & chr(13) & chr(10) 'VESSEL
       '      strHTML = strHTML&"<td nowrap><strong><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & IMPORT_DOCUMENT	      & " </font></strong></td>" & chr(13) & chr(10) 'IMPORT DOCUMENT
       '      strHTML = strHTML&"<td nowrap><strong><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & PROVEEDOR	            & " </font></strong></td>" & chr(13) & chr(10) 'PROVEEDOR
       '      strHTML = strHTML&"<td nowrap><strong><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & INVOICE	              & " </font></strong></td>" & chr(13) & chr(10) 'INVOICE
       '      strHTML = strHTML&"<td nowrap><strong><font color='"&str_fcolor&"' size=""1"" face=""Arial, Helvetica, sans-serif""> " & DESCRIPTION_CODE	    & " </font></strong></td>" & chr(13) & chr(10) 'DESCRIPTION CODE
       ...
       ' strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & NOTIFICACION_GUIA	   &" </font></strong></td>" & chr(13) & chr(10) 'NOTIFICACION DE GUIA
       ' strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & FECHA_NOTIFICACION 	 &" </font></strong></td>" & chr(13) & chr(10) 'FECHA DE NOTIFICACION
       ...
       ' strHTML = strHTML&"<td nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & INCOTERMS	           &" </font></strong></td>" & chr(13) & chr(10) 'INCOTERMS
    ...
    'Funcion para escribir el encabezado del reporte en la cadena HTML
    function agregarfilaDetalle(INVOICE, MODEL, DESCRIPCION_COMERCIAL, DESCRIPTION_CODE, QTY, INCOTERMS )
       'OTD2                  'OTD2
       'GUIA_MASTER	          'GUIA MASTER
       'GUIA_HOUSE	          'GUIA HOUSE
       'FORWARDER_AIR_LINE    'FORWARDER Y/O AIR  LINE
       'AEROPUERTO_SALIDA	    'AEROPUERTO DE SALIDA
       'NOTIFICACION_GUIA	    'NOTIFICACION DE GUIA
       'FECHA_NOTIFICACION 	  'FECHA DE NOTIFICACION
       'IMPORT_DOCUMENT	      'IMPORT DOCUMENT
       'PROVEEDOR	            'PROVEEDOR
       'INVOICE	              'INVOICE
       'MODEL 	              'MODEL
       'DESCRIPCION_COMERCIAL 'DESCRIPCION COMERCIAL
       'DESCRIPTION_CODE	    'DESCRIPTION CODE
       'QTY	                  'QTY
       'INCOTERMS	            'INCOTERMS
       'SERIAL_NUMBER	        'SERIAL NUMBER
       'ORIGIN_ETD	          'ORIGIN   ETD
       'ETA_LAX  	          'ETA  LAX./
       'ATA_CUSTOM	          'ATA CUSTOM
       'RESQUEST_DUTIES	      'RESQUEST DUTIES
       'FECHA_DE_REVALIDACION 'FECHA DE  REVALIDACION
       'FECHA_DE_PREVIO	      'FECHA DE PREVIO
       'DATE_OF_CLEARANCE	    'DATE OF CLEARANCE
       'ATA_WH	              'ATA W-H
       'TIMEOFDELIVERY        'TIME OF DELIVERY IN SEM
       'REMARKS	              'REMARKS
       'WEEK	                'WEEK
       'AMOUNTOFDUTIES	      'AMOUNT OF DUTIES
       'NUM_INVOICECUSTOM	    'NUM. INVOICE CUSTOM
       'DATEINVOICECUSTOM     'DATE OF INVOICE CUSTOM

       strHTML = strHTML& "<tr  align=""center"" >"& chr(13) & chr(10)
       strHTML = strHTML&"<td colspan=""10"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & " "                   &" </font></strong></td>" & chr(13) & chr(10) 'REFERENCIA
       strHTML = strHTML&"<td                nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & INVOICE	              &" </font></strong></td>" & chr(13) & chr(10) 'INVOICE
       strHTML = strHTML&"<td                nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & MODEL 	              &" </font></strong></td>" & chr(13) & chr(10) 'MODEL
       strHTML = strHTML&"<td                nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & DESCRIPCION_COMERCIAL &" </font></strong></td>" & chr(13) & chr(10) 'DESCRIPCION COMERCIAL
       strHTML = strHTML&"<td                nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & DESCRIPTION_CODE	    &" </font></strong></td>" & chr(13) & chr(10) 'DESCRIPTION CODE
       strHTML = strHTML&"<td                nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & QTY	                  &" </font></strong></td>" & chr(13) & chr(10) 'QTY
       strHTML = strHTML&"<td                nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & INCOTERMS	            &" </font></strong></td>" & chr(13) & chr(10) 'INCOTERMS
       strHTML = strHTML&"<td colspan=""15"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""> " & 	""                  &" </font></strong></td>" & chr(13) & chr(10) 'SERIAL NUMBER
       strHTML = strHTML & "</tr>"& chr(13) & chr(10)
    end function
     '-------------------------------------------------------------------------------------------------------------------------------
               ...
               While NOT RsRep.EOF AND not banCargaRun
                ' ya tenemos los registros a nivel pedimento, ahora vamos por todos los campos a nivel pedimento restantes
                    ...
                    if Bolbanrecti = True then
                         ...
                         '         strForwarder = RForwLA.Fields.Item("nomb01").Value
                         '     else
                         '         strForwarder = ""
                         '     end if
                         '     RForwLA.close
                         ...
                         if StrRefer <> "" then
                            ...
                            ' Vamos por las mercancias
                             strTypeMer = ""
                             booisRefacc = false
                             Set RMercTypeVal = Server.CreateObject("ADODB.Recordset")
                             RMercTypeVal.ActiveConnection = MM_EXTRANET_STRING
                             strSqlSel = " Select tpmerc05 " & _
                                         " from d05artic  " & _
                                         " where refe05='" & ltrim(StrRefer) & "' "
                             RMercTypeVal.Source = strSqlSel
                             RMercTypeVal.CursorType = 0
                             RMercTypeVal.CursorLocation = 2
                             RMercTypeVal.LockType = 1
                             RMercTypeVal.Open()
                             if not RMercTypeVal.eof then
                               While NOT RMercTypeVal.EOF
                                      strTypeMer = RMercTypeVal.Fields.Item("tpmerc05").Value
                                      if strTypeMer <> "" and strTypeMer = "R" then
                                         booisRefacc = true
                                      end if
                                   RMercTypeVal.movenext
                               wend
                             else
                               booisRefacc = true
                             end if
                             ...
                             'if StrRefer = "DAI08-0884" then
                             '   Response.Write("booisRefacc=")
                             '   Response.Write(booisRefacc)
                             '   Response.End
                             'end if
                             ...
                             intcontped = 1
                               ...
                               While NOT RMercancias.EOF
                                   ...
                                   'end if
                                       ...
                                       StrPQTY	                 = strQTY       'QTY
                                       StrPINCOTERMS	           = RMercancias.Fields.Item("TERFAC39").Value 'INCOTERMS
                                       ...
                                       '**************************************************************************
                                       ' StrETA_CUSTOM_CLEARANCE = SumarDiasSinFinSemana( RsRep.Fields.Item("etalax01").Value , 2)
                                       ' StrColorfila = 0
                                       ' if isdate(RsRep.Fields.Item("fecent01").Value) and isdate(RsRep.Fields.Item("etalax01").Value) then
                                       '     IndFila = DateDiff("d",StrETA_CUSTOM_CLEARANCE , RsRep.Fields.Item("fecent01").Value )
                                       '     if IndFila = 0 then
                                       '        StrColorfila = 1
                                       '     else
                                       '        StrETA_CUSTOM_CLEARANCE = RsRep.Fields.Item("fecent01").Value 'si las fechas estimada y la real no coinciden ponemos como eta la ata y de ahi recalculamos las siguientes
                                       '        if IndFila < 0 then
                                       '            StrColorfila = 2
                                       '         else
                                       '            StrColorfila = 3
                                       ...
                                       ' StrETA_C_P = SumarDiasSinFinSemana(StrETA_CUSTOM_CLEARANCE , 3)

                                       ' if isdate(strATAC_P) then
                                       '     IndFila = DateDiff("d",StrETA_C_P , strATAC_P )
                                       '     if IndFila <> 0 then
                                       '        StrETA_C_P = strATAC_P 'si las fechas estimada y la real no coinciden ponemos como eta la ata y de ahi recalculamos las siguientes
                                       ...
                                       ' StrETA_W_H = SumarDiasSinFinSemana(StrETA_C_P , 1)
                                       ' if isdate(strFechaATAWH ) then
                                       '     IndFila = DateDiff("d",StrETA_W_H , strFechaATAWH )
                                       '     if IndFila <> 0 then
                                       '        StrETA_W_H = strFechaATAWH 'si las fechas estimadas y la real no coinciden ponemos como eta la ata y de ahi recalculamos las siguientes
                                       '        if StrColorfila = 0 then
                                       '           if IndFila < 0 then
                                       '              StrColorfila = 2
                                       '           else
                                       ...
                                       ' StrPETA_CUSTOM_CLEARANCE = formatofechaNum(StrETA_CUSTOM_CLEARANCE)
                                       ' StrPETA_C_P              = formatofechaNum(StrETA_C_P)
                                       ' StrPETA_W_H              = formatofechaNum(StrETA_W_H)
                                       ' StrPATA_CP               = formatofechaNum(strATAC_P)       'ATA C./P.
                                       '*************************************************************************
                                       ...
                                       if intcontemp = 1 then
                                           ...
                                           StrPAMOUNTOFDUTIES  = "0"  'AMOUNT OF DUTIES
                                           StrPREMARKS         = ""  'REMARKS
                                       end if
                                       ...
                                       'agregarfilaHTML StrColorfila, StrREFERENCIA, StrPOTD2, StrPGUIA_MASTER, StrPGUIA_HOUSE, StrPP_O, StrPFORWARDER_AIR_LINE, StrPAEROPUERTO_SALIDA, StrCUSTOM_OF_DISPATCH, StrPNOTIFICACION_GUIA, StrPFECHA_NOTIFICACION, StrPVESSEL, StrPIMPORT_DOCUMENT, StrPPROVEEDOR, StrPINVOICE, StrPMODEL, StrPDESCRIPCION_COMERCIAL, StrPDESCRIPTION_CODE, StrPQTY, StrPINCOTERMS, StrPSERIAL_NUMBER, StrPCERT_NOM,	StrPORIGIN_ETD, StrPETA_LAX, StrPATA_CUSTOM, StrPRESQUEST_DUTIES, StrPFECHA_DE_REVALIDACION, StrPFECHA_DE_PREVIO, StrPETA_CUSTOM_CLEARANCE, StrPDATE_OF_CLEARANCE, StrPETA_C_P,  StrPATA_CP ,StrPETA_W_H, StrPATA_WH, StrPTIMEOFDELIVERY , StrPREMARKS, StrPMODALIDAD , StrPWEEK, StrPAMOUNTOFDUTIES, StrPNUM_INVOICECUSTOM, StrPDATEINVOICECUSTOM
                                       'agregarfilaHTML StrREFERENCIA, StrPOTD2, StrPGUIA_MASTER, StrPGUIA_HOUSE, StrPFORWARDER_AIR_LINE, StrPAEROPUERTO_SALIDA, StrPNOTIFICACION_GUIA, StrPFECHA_NOTIFICACION, StrPIMPORT_DOCUMENT, StrPPROVEEDOR, StrPINVOICE, StrPMODEL, StrPDESCRIPCION_COMERCIAL, StrPDESCRIPTION_CODE, StrPQTY, StrPINCOTERMS, StrPSERIAL_NUMBER,	StrPORIGIN_ETD, StrPETA_LAX, StrPATA_CUSTOM, StrPRESQUEST_DUTIES, StrPFECHA_DE_REVALIDACION, StrPFECHA_DE_PREVIO, StrPDATE_OF_CLEARANCE, StrPATA_WH, StrPTIMEOFDELIVERY , StrPREMARKS, StrPWEEK, StrPAMOUNTOFDUTIES, StrPNUM_INVOICECUSTOM, StrPDATEINVOICECUSTOM
                               ...
                               Wend
                                 ...
                                 'desplegamos fila
                                       ...
                                       if booisRefacc = true then
                                               ...
                                               Set RMercTypeVal = Server.CreateObject("ADODB.Recordset")
                                               RMercTypeVal.ActiveConnection = MM_EXTRANET_STRING
                                               strSqlSel = " Select  refe05,pedi05, desc05, cpro05,descod05,caco05 " & _
                                                           " from d05artic  " & _
                                                           " where refe05='" & ltrim(StrRefer) & "' "
                                               'Response.Write(strSqlSel)
                                               'Response.End
                                               ...
                                               if not RMercTypeVal.eof then
                                                 ...
                                                 intcontDescMerc = 1
                                                 While NOT RMercTypeVal.EOF
                                                     if RMercTypeVal.Fields.Item("pedi05").Value <> ""  then
                                                        ...
                                                        if UCase(ltrim(RMercTypeVal.Fields.Item("pedi05").Value)) <> "N/A" then
                                                           if intcontped = 1 then
                                                              strPO_Pedido  = RMercTypeVal.Fields.Item("pedi05").Value
                                                           else
                                                              strPO_Pedido  = strPO_Pedido& ", "&RMercTypeVal.Fields.Item("pedi05").Value
                                                           end if
                                                           intcontped = intcontped + 1
                                                        else
                                                           strPO_PedidoNA = "N/A"
                                                     ...
                                                     if intcontemp = 1 then
                                                        strDescMerc   = RMercTypeVal.Fields.Item("desc05").Value
                                                        strModelo     = RMercTypeVal.Fields.Item("cpro05").Value
                                                        strDescCode   = RMercTypeVal.Fields.Item("descod05").Value
                                                        strQTY        = RMercTypeVal.Fields.Item("caco05").Value
                                                     else
                                                        strDescMerc   = strDescMerc & ", "& RMercTypeVal.Fields.Item("desc05").Value
                                                        strModelo     = strModelo & ", "& RMercTypeVal.Fields.Item("cpro05").Value
                                                        strDescCode   = strDescCode & ", " & RMercTypeVal.Fields.Item("descod05").Value
                                                        strQTY        = strQTY + RMercTypeVal.Fields.Item("caco05").Value
                                                     end if
                                                     intcontemp = intcontemp + 1
                                                     RMercTypeVal.movenext
                                                 Wend
                                               ...
                                               if StrRefer <> "" then
                                                   ...
                                                   Rfracciones.Open()
                                                   if not Rfracciones.eof then
                                                       strQTYtmp = Rfracciones.Fields.Item("QTY").Value
                                                   end if
                                                   Rfracciones.close
                                                   set Rfracciones = Nothing
                                               end if
                           ...
                           '**************************************************************************************************************
                             ...
                             '*************************************************************
                                       ...
                                       'if not RMercancias.eof then
                                       '  While NOT RMercancias.EOF
                                       '     agregarfilaDetalle  RMercancias.Fields.Item("fact05").Value, RMercancias.Fields.Item("cpro05").Value, RMercancias.Fields.Item("desc05").Value, RMercancias.Fields.Item("tpmerc05").Value, RMercancias.Fields.Item("caco05").Value, RMercancias.Fields.Item("TERFAC39").Value
                                       '     'agregarfilaHTML "","","","","","","","","","",RMercancias.Fields.Item("fact05").Value, RMercancias.Fields.Item("cpro05").Value, RMercancias.Fields.Item("desc05").Value, RMercancias.Fields.Item("tpmerc05").Value, RMercancias.Fields.Item("caco05").Value, RMercancias.Fields.Item("TERFAC39").Value ,"" ,"","","","","","","","","","","","","",""
                                       '     'agregarfilaHTML   ,  ,  ,  ,  ,  ,  ,  ,  ,  , StrPINVOICE                           , StrPMODEL                              , StrPDESCRIPCION_COMERCIAL              , StrPDESCRIPTION_CODE                     , StrPQTY                                , StrPINCOTERMS, ,	 ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  ,  , StrPDATEINVOICECUSTOM
                                       '     RMercancias.movenext
                                       '  Wend
                                       'end if
                                       'RMercancias.close

...
<td height=52 class=xl46 id="_x0000_s1071" x:autofilter="all"
  x:autofilterrange="$A$1:$BW$800" width=125 style='height:39.0pt;width:94pt'
...
act2.open()
 ...
 "left join "&Oficina&"_extranet.ssfact39 as f on f.refcia39 = i.refcia01 and f.adusec39 = i.adusec01 and f.patent39 = i.patent01  and f.terfac39<>''  "&_

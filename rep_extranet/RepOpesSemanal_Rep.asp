                ...
                if ok="ok" then
					  ...
					  sumAcumCont=0
                        ...
                        if it=1 then
                          ...
                          Set oRange = nombhoja.Range("A1:H1")
                          ...
                          ir=ir+1
                          Set oRange = nombhoja.Range("A"&ir&":H"&ir)
                          oRange.Value = Array(" ", "",titulo ,"SEM.", "SEM.", "ACUM.","ACUM.","ACUM.")
                          oRange.Font.Bold = true
                          oRange.Font.color = "#FFFFFF"
                          oRange.Interior.Color = "#336699"
                          'oRange.Borders(c.xlEdgeBottom).Weight = c.xlThick
                          ...
                          ir=ir+1
                          Set oRange = nombhoja.Range("A"&ir&":H"&ir)
                     oRange.Value = Array(" PATENTE", "CVE.CLI", "NOMBRE DEL CLIENTE", "No.OP'S", "V.ADU", "NoOP'S","V.ADU","CONT")
                          oRange.Font.Bold = true
                          oRange.Font.color = "#FFFFFF"
                          oRange.Interior.Color = "#336699"
                          'oRange.Borders(c.xlEdgeBottom).Weight = c.xlThick
                          ...
                          nombhoja.Range("D:H").ColumnWidth = 10
                        else
                          ir=ir+3
                          titulo=" IMPORTACION"
                          Tabla="ssdagi01"
                    ...
                    oRange.Value = Array(" PATENTE", "CVE.CLI", "NOMBRE DEL CLIENTE", "No.OP'S", "V.ADU", "NoOP'S","V.ADU","CONT")
                      ...
                      sqlContenedores= " select count(numcon40) as conte,fecpag01,patent01,cvecli01,nomcli01 "&_
                                       " from "&tabla&" join sscont40 on refcia01=refcia40 "&_
                                       " where cvecli01='"&RSCVEPAT.fields.item("cvecli01").value&"' " &_
                                       " and patent01='"&RSCVEPAT.fields.item("patent01").value&"' " &_
                                       " and firmae01<>'' and cveped01<>'R1' and "&STRFecha&" "&_
                                       " group by patent01" &_
                                       " order by cvecli01 desc "  
					   '----------------------
                      ...
                      ' valor el aduana anual
						...
						' acumulado de contenedores
                             set RSCont = server.CreateObject("ADODB.Recordset")
                             RSCont.ActiveConnection = MM_STRING
                             RSCont.Source= sqlContenedores
                             RSCont.CursorType = 0
                             ...
                             RSCont.Open()
                                ...
                                if not RSCont.eof then
                                    AcumCont= RSCont.fields.item("conte").value
                                else
                                    AcumCont=0
                                end if
                             ...
                             RSCont.close
                             set RSCont = nothing	 
							 'response.Write(sqlContenedores)
							 'response.End()
                      ...
                      sumAcumCont=sumAcumCont+AcumCont  
                      '''''''''''''''''''''''''''''''''''''''''''
                      ...
                      '''''''''''''''''''''''''''''''''''''''''''
                          ir=ir+1   ' este es el indice de la fila
                                  ...
                                  nombhoja.Range("H"&ir).Value = AcumCont 
                      ...
                      'IEsum3931=IEsum3931+sum3931
                        ...
                        ' imprime los totales de no de operaciones y valor en aduna.
                                  ...
                                  nombhoja.Range("H"&ir).Value = sumAcumCont
                        ...
                        'ir=ir+1   ' este es el indice de la fila SE DEJO DE USAR ESTA PATENTE
'                                  nombhoja.Range("A"&ir).Value = ""
'                                  nombhoja.Range("B"&ir).Value = ""
'                                  nombhoja.Range("C"&ir).Value = ""

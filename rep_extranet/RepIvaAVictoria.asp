...
'Response.Write(Request.Form("Permisos"))
'Response.end()
...
if strTipoUsuario = MM_Cod_Admon and not blnAplicaFiltro then
   ...
   strHTML2 = strHTML2 & "<table bordercolor=""#C1C1C1"" border=""2"" align=""center"" cellpadding=""0"" cellspacing=""0"">" & chr(13) & chr(10)
		strHTML2 = strHTML2 & "<tr bgcolor=""#006699"" align=""center"">"& chr(13) & chr(10)
		   ...
		   strHTML2 = strHTML2 & "<td width=""90"" align=""right"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">REFERENCIA" & chr(13) & chr(10)

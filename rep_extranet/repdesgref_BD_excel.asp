...
MM_EXTRANET_STRING_ATV = ODBC_POR_ADUANA("ATV")
MM_EXTRANET_STRING_ATM = ODBC_POR_ADUANA("ATM")
...
if strTipoFiltro  = "Fechas" then
   if strTipoPedimento  = "1" then
     tmpTipo = "IMPORTACION"
     strSQL = "SELECT DISTINCT adusec01,ifnull(valdol01,0) as valdol01,tipopr01,ifnull(valmer01,0) as valmer01,ifnull(factmo01,0) as factmo01, ifnull(p_dta101,0) as p_dta101, ifnull(t_reca01,0) as t_reca01, ifnull(i_dta101,0) as i_dta101, cvecli01, refcia01, fecpag01, ifnull(valfac01,0) as valfac01, fletes01, segros01, ifnull(cvepvc01,'0') as cvepvc01, tipcam01, patent01, numped01, totbul01, cveped01, cveadu01, desf0101, nompro01, cvepro01, cvepod01, nombar01, tipopr01, fecent01,anexol01,regime01 FROM ssdagi01 WHERE fecpag01 >='"&FormatoFechaInv(strDateIni)&"' AND fecpag01 <='"&FormatoFechaInv(strDateFin)&"' " & Permi & " and firmae01 !='' order by refcia01"
   end if
   if strTipoPedimento  = "2" then
     tmpTipo = "EXPORTACION"
     strSQL = "SELECT DISTINCT adusec01,ifnull(valdol01,0) as valdol01,tipopr01, ifnull(factmo01,0) as factmo01, ifnull(p_dta101,0) AS p_dta101, ifnull(t_reca01,0) as t_reca01, ifnull(i_dta101,0) as i_dta101, cvecli01, refcia01, fecpag01, ifnull(valfac01,0) as valfac01, ifnull(fletes01,0) as fletes01, ifnull(segros01,0) as segros01,ifnull(cvepvc01,'0') as cvepvc01, tipcam01, patent01, numped01, totbul01, cveped01, cveadu01, ifnull(desf0101,' ') as desf0101, ifnull(nompro01,' ') as nompro01, cvepro01, ifnull(cvepod01,' ') as cvepod01, nombar01, tipopr01, fecpre01,anexol01,regime01 FROM ssdage01 WHERE fecpag01 >='"&FormatoFechaInv(strDateIni)&"' AND fecpag01 <='"&FormatoFechaInv(strDateFin)&"' " & Permi & " and firmae01 !='' order by refcia01"
   end if
else
   if strTipoFiltro  = "Descripcion" then
    if strTipoPedimento2  = "1" then
     tmpTipo = "IMPORTACION"
     strSQL = "SELECT distinct adusec01,ifnull(valdol01,0) as valdol01,tipopr01,ifnull(valmer01,0) as valmer01,ifnull(factmo01,0) as factmo01, ifnull(p_dta101,0) as p_dta101, ifnull(t_reca01,0) as t_reca01, ifnull(i_dta101,0) as i_dta101, cvecli01, refcia01, fecpag01, ifnull(valfac01,0) as valfac01, fletes01, segros01, ifnull(cvepvc01,'0') as cvepvc01, tipcam01, patent01, numped01, totbul01, cveped01, cveadu01, desf0101, nompro01, cvepro01, cvepod01, nombar01, tipopr01, fecent01,anexol01,regime01 FROM ssdagi01,ssfrac02 WHERE refcia01 = refcia02 and d_mer102 like '%" & strDescripcion & "%' and fecpag01 >='"&FormatoFechaInv(strDateIni2)&"' AND fecpag01 <='"&FormatoFechaInv(strDateFin)&"' " & Permi & " and firmae01 !='' order by refcia01"
    ' Response.Write(strSQL)
    ' Response.End
   end if
   if strTipoPedimento2  = "2" then
     tmpTipo = "EXPORTACION"
     strSQL = "SELECT distinct adusec01,ifnull(valdol01,0) as valdol01,tipopr01, ifnull(factmo01,0) as factmo01, ifnull(p_dta101,0) AS p_dta101, ifnull(t_reca01,0) as t_reca01, ifnull(i_dta101,0) as i_dta101, cvecli01, refcia01, fecpag01, ifnull(valfac01,0) as valfac01, ifnull(fletes01,0) as fletes01, ifnull(segros01,0) as segros01, ifnull(cvepvc01,'0') as cvepvc01, tipcam01, patent01, numped01, totbul01, cveped01, cveadu01, desf0101, nompro01, cvepro01, cvepod01, nombar01, tipopr01, fecpre01,anexol01,regime01 FROM ssdage01,ssfrac02 WHERE refcia01 = refcia02 and d_mer102 like '%" & strDescripcion & "%' and fecpag01 >='"&FormatoFechaInv(strDateIni2)&"' AND fecpag01 <='"&FormatoFechaInv(strDateFin)&"' " & Permi & " and firmae01 !='' order by refcia01"
   end if
   end if
end if
...
'  response.end()
  ...
  ' Comienza el HTML, se pintan los titulos de las columnas
    ...
    strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">RFC Proveedor</td>" & chr(13) & chr(10)
    ...
    strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">TotalPagosHechos2</td>" & chr(13) & chr(10)
        if session("GUsuarioAtlas") = "SI" and tmpTipo = "IMPORTACION" then
		   strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Salida de Orígen</td>" & chr(13) & chr(10)
           strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Fecha Estimada de Arribo</td>" & chr(13) & chr(10)
		   strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Solicitud de Anticipos</td>" & chr(13) & chr(10)
		   strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Depósito de Anticipos</td>" & chr(13) & chr(10)
		   strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Llegada a Planta</td>" & chr(13) & chr(10)
		   strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Referencia Atlas</td>" & chr(13) & chr(10)
		   strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Cuenta de Gastos Atlas</td>" & chr(13) & chr(10)
           strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">Nombre Contenedor</td>" & chr(13) & chr(10)
		end if
   ...
   strCtaGas=""
	 ...
	 dblsald31=0
        ...
        strSQL1="select DISTINCT A.cgas31,B.fech31,B.suph31, B.coad31, B.csce31, B.chon31, B.piva31, B.anti31,B.sald31 from d31refer as A LEFT JOIN e31cgast as B ON A.cgas31=B.cgas31 where B.esta31='I' and A.refe31='"&trim(strRefer)&"' " & permi2

        'if trim(strRefer) = "AGD08-2039" or trim(strRefer) =  "AGD08-2076" or trim(strRefer) = "AGD08-2138" or trim(strRefer) =  "AGD08-2177" or trim(strRefer) = "AGD08-2260"   then
...
pRefer= trim(pRefer)
      ...
      strSQL3="select DISTINCT ifnull(fpagoi36,'0') as fpagoi36 ,ifnull(import36,0) as import36 from sscont36 where refcia36='"&pRefer&"' and adusec36='" & strAduSec & "' and patent36='"&strPatente&"'" 
      ...
      strDivi = ""
        ...
        Observaciones = RsRep.Fields.Item("anexol01").Value
         ...
         if (RsRep.Fields.Item("cveadu01").Value = "80" or RsRep.Fields.Item("cveadu01").Value = "48") and RsRep.Fields.Item("cvecli01").Value = 40 then
      ...
      'Aqui se obtienen las fracciones por referencia
			strSQL2="select DISTINCT ordfra02,fraarn02,d_mer102,cancom02,cancom02,u_medc02,cantar02,u_medt02,ifnull(vmerme02,0) as vmerme02,vaduan02,ifnull(tasadv02,0) as tasadv02,ifnull(p_adv102,0) as p_adv102,ifnull(i_adv102,0) as i_adv102,ifnull(i_iva102,0) as i_iva102,ifnull(i_adv102,0) as i_adv102,ifnull(i_adv202,0) as i_adv202,i_cc0102,ifnull(i_cc0202,0) as i_cc0202,paiori02,paiscv02 from ssfrac02 where refcia02='"&pRefer&"' and adusec02='" & strAduSec &"' and patent02='"&strPatente&"'"
      if strTipoFiltro  = "Descripcion" then
         strSQL2="select  DISTINCT ordfra02,fraarn02,d_mer102,cancom02,cancom02,u_medc02,cantar02,u_medt02,ifnull(vmerme02,0) as vmerme02,vaduan02,ifnull(tasadv02,0) as tasadv02,ifnull(p_adv102,0) as p_adv102,ifnull(i_adv102,0) as i_adv102,ifnull(i_iva102,0) as i_iva102,ifnull(i_adv102,0) as i_adv102,ifnull(i_adv202,0) as i_adv202,i_cc0102,ifnull(i_cc0202,0) as i_cc0202,paiori02,paiscv02 from ssfrac02 where refcia02='"&pRefer& "' and d_mer102 like '%" & strDescripcion & "%'  and adusec02='" & strAduSec &"' and patent02='"&strPatente&"'"
      ...
      'Recorremos las Fracciones
        ...
        strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"&TipoOper(RsRep.Fields.Item("tipopr01").Value)&"&nbsp;</font></td>" & chr(13) & chr(10) 'Tipo de Pedimento
         ...
         if (RsRep.Fields.Item("cveadu01").Value = "80" or RsRep.Fields.Item("cveadu01").Value = "48") and RsRep.Fields.Item("cvecli01").Value = 40 then
          ...
          strSQL= "select DISTINCT REFCIA12,ordfra12,cveide12,tipoid12,numper12 from ssipar12 where ordfra12 =" &  RsRep2.Fields.Item("ordfra02").Value & " and refcia12='" &  pRefer & "' and adusec12='" & strAduSec &"' and patent12='"&strPatente&"'"
...
'********************************************************************************************************************************************************************************************************************************************************
        strSQL= "select fdsp01,rcli01,alea01,feta01,feorig01, nomdiv01 from c01refer where refe01 ='" &  pRefer & "'"
...
'       if RsRep.Fields.Item("cveadu01").Value = "80" OR RsRep.Fields.Item("cveadu01").Value  = "24" THEN
      strSQL4="select DISTINCT numfac39,terfac39 from ssfact39 where refcia39='"&pRefer&"' and adusec39='"&strAduSec&"' and patent39='"&strPatente&"'"
      ...
      if RsRep.Fields.Item("cveadu01").Value = "80" OR RsRep.Fields.Item("cveadu01").Value  = "24" or RsRep.Fields.Item("cveadu01").Value = "48"  THEN 'Cambio pbm
       strNumFacturas = ""
      END IF  'Cambio pbm

      if not RsRep4.eof then
       IF trim(strNumFacturas) = "" then
     ...
     '    if RsRep.Fields.Item("cveadu01").Value = "80" OR RsRep.Fields.Item("cveadu01").Value  = "24" THEN 'Cambio pbm
      ...
      '*********************************************************************************************************
      strRFCProv = ""
      strcveProv = RsRep.Fields.Item("cvepro01").Value
      QryDatProv = " SELECT DISTINCT NOMPRO22, IRSPRO22 FROM SSPROV22 WHERE CVEPRO22= '"& strcveProv &"'"

			Set RsDatProv = Server.CreateObject("ADODB.Recordset")
			RsDatProv.ActiveConnection = MM_EXTRANET_STRING
			RsDatProv.Source = QryDatProv
			RsDatProv.CursorType = 0
			RsDatProv.CursorLocation = 2
			RsDatProv.LockType = 1

			RsDatProv.Open()
      if not RsDatProv.eof then
         while not RsDatProv.eof
           strRFCProv = RsDatProv.Fields.Item("IRSPRO22").Value
     	     RsDatProv.movenext
         wend
      end if
      RsDatProv.close
      Set RsDatProv = Nothing
      ...
      '*********************************************************************************************************
        ...
        strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"&strRFCProv&"</font></td>" & chr(13) & chr(10) 'RFC de proveedor
        ...
        if intContReg=1 then
         if not RsRep.Fields.Item("cveadu01").Value = "24" and not RsRep.Fields.Item("cveadu01").Value = "80" and not RsRep.Fields.Item("cveadu01").Value = "48" then
		  ...
		  strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"&CampoSumaValoresFracc2("vaduan02", pRefer,strAduSec,strPatente)&"</font></td>" & chr(13) & chr(10) 'Valor Aduana
      ...
      strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">0</font></td>" & chr(13) & chr(10)'Val. Dol. Fact.
		...
		strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"&RsRep2.Fields.Item("ordfra02").Value&"</font></td>" & chr(13) & chr(10) 'Orden Fraccion Arancearia **********************************************************************************************************************************************************
   ...
   if RsRep.Fields.Item("cveadu01").Value = "48"  THEN 'Cambio pbm

   strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10) 'Contacto
	strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10) 'R.F.C. del Cliente
    ...
    strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">0</font></td>" & chr(13) & chr(10) 'PagosHechosConcepto2
    'AQUI EMPIEZA MODIFICACION PARA ATLAS
	'SI ES USUARIO ATLAS Y ES IMPORTACION
    if session("GUsuarioAtlas") = "SI" and tmpTipo = "IMPORTACION" then
	  strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"& trim(RsReferencia.Fields.Item("feorig01").Value) & "</font></td>" & chr(13) & chr(10) 'Salida de Origen
      strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"& trim(RsReferencia.Fields.Item("feta01").Value) & "</font></td>" & chr(13) & chr(10) 'ETA
      ' BUSCA SOLICITUDES, DEPOSITOS DE ANTICIPOS y LLEGADA A PLANTA
	  Set anticipos_planta = Server.CreateObject("ADODB.Recordset")
	  anticipos_planta.ActiveConnection = MM_EXTRANET_STRING_STATUS
	  soldep = "SELECT DISTINCT f_fecha from etxpd where (c_referencia = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' and n_etapa=4) or (c_referencia = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' and n_etapa=5) or (c_referencia = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' and n_etapa=15) group by n_etapa order by n_etapa"
	  anticipos_planta.Source = soldep
	  anticipos_planta.CursorType = 0
      anticipos_planta.CursorLocation = 2
      anticipos_planta.LockType = 1
	  anticipos_planta.Open()


	  band = 0
	  if not anticipos_planta.eof then
	    while not anticipos_planta.eof
		  'TRATA DE OBTENER LAS 3 ETAPAS(SOLICITUD DE ANTICIPO, DEPOSITO DE ANTICIPO, Y LLEGADA A PLANTA)
		  strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"& trim(anticipos_planta.Fields.Item("f_fecha").Value) & "</font></td>" & chr(13) & chr(10)
          band = band + 1
		  anticipos_planta.movenext
		wend
		 'SI SOLO HUBO UN REGISTRO, PONE DOS COLUMNAS VACIAS
		 if band = 1 then
		   strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10)
		   strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10)
	     end if
		 'SI SOLO HUBO DOS REGISTROS, PONE UNA COLUMNA VACIA
		 if band = 2 then
		   strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10)
	     end if
	  else
	    ...
	    anticipos_planta.close
        set anticipos_planta = Nothing

	  'BUSCA CUENTA DE GASTOS DE ATLAS
      Set Igualrefe_atv = Server.CreateObject("ADODB.Recordset")
	  Igualrefe_atv.ActiveConnection = MM_EXTRANET_STRING_ATV
	  refeatlas_atv = "SELECT DISTINCT REFE01 from c01refer where refefor01 = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' "
	  Igualrefe_atv.Source = refeatlas_atv
	  Igualrefe_atv.CursorType = 0
      Igualrefe_atv.CursorLocation = 2
      Igualrefe_atv.LockType = 1
	  Igualrefe_atv.Open()

	   ' SI LA ENCUENTRA LA REFERENCIA, BUSCA LA CUENTA DE GASTOS
	   if not Igualrefe_atv.eof then
	      strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & trim(Igualrefe_atv.Fields.Item("REFE01").Value) & "</font></td>" & chr(13) & chr(10) 'Refe Atlas
		  Set Cgastos_atv = Server.CreateObject("ADODB.Recordset")
	      Cgastos_atv.ActiveConnection = MM_EXTRANET_STRING_ATV
	      factura_atv = "SELECT DISTINCT cgas21 from d21paghe where refe21 = '" & trim(Igualrefe_atv.Fields.Item("REFE01").Value) & "' and cgas21 != ' '  group by cgas21"
	      Cgastos_atv.Source = factura_atv
	      Cgastos_atv.CursorType = 0
          Cgastos_atv.CursorLocation = 2
          Cgastos_atv.LockType = 1
	      Cgastos_atv.Open()

			if not Cgastos_atv.eof then
   		       strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & trim(Cgastos_atv.Fields.Item("cgas21").Value) & "</font></td>" & chr(13) & chr(10) '
			else
 			   strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10) '
			end if
		else
		   'SINO ENCUENTRA LA REFERENCIA EN ATV, LA BUSCA EN "ATM"
		   Set Igualrefe_atm = Server.CreateObject("ADODB.Recordset")
	       Igualrefe_atm.ActiveConnection = MM_EXTRANET_STRING_ATM
	       refeatlas_atm = "SELECT DISTINCT REFE01 from c01refer where refefor01 = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' "
	       Igualrefe_atm.Source = refeatlas_atm
	       Igualrefe_atm.CursorType = 0
           Igualrefe_atm.CursorLocation = 2
           Igualrefe_atm.LockType = 1
	       Igualrefe_atm.Open()

		  if not Igualrefe_atm.eof then
	          strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & trim(Igualrefe_atm.Fields.Item("REFE01").Value) & "</font></td>" & chr(13) & chr(10) 'Refe Atlas
		      Set Cgastos_atm = Server.CreateObject("ADODB.Recordset")
	          Cgastos_atm.ActiveConnection = MM_EXTRANET_STRING_ATM
	          factura_atm = "SELECT DISTINCT cgas21 from d21paghe where refe21 = '" & trim(Cgastos_atm.Fields.Item("REFE01").Value) & "' and cgas21 != ' '  group by cgas21"
	          Cgastos_atm.Source = factura_atm
	          Cgastos_atm.CursorType = 0
              Cgastos_atm.CursorLocation = 2
              Cgastos_atm.LockType = 1
	          Cgastos_atm.Open()

			 if not Cgastos_atm.eof then
		       strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & trim(Cgastos_atm.Fields.Item("cgas21").Value) & "</font></td>" & chr(13) & chr(10) '
			 else
 			   strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10) '
			 end if
		  else
	...
	strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"&strNumIncoterms&"</font></td>" & chr(13) & chr(10) 'Incoterms
    strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"&retornaTotalPagosHechos(pRefer,"2","ok")&"</font></td>" & chr(13) & chr(10) 'PagosHechosConcepto2
   'AQUI EMPIEZA MODIFICACION PARA ATLAS
   'SI ES USUARIO ATLAS Y ES IMPORTACION
    if session("GUsuarioAtlas") = "SI" and tmpTipo = "IMPORTACION" then
	  strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"& trim(RsReferencia.Fields.Item("feorig01").Value) & "</font></td>" & chr(13) & chr(10) 'Salida de Origen
      strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">"& trim(RsReferencia.Fields.Item("feta01").Value) & "</font></td>" & chr(13) & chr(10) 'ETA
      ' BUSCA SOLICITUDES Y DEPOSITOS DE ANTICIPOS
	  Set anticipos_planta = Server.CreateObject("ADODB.Recordset")
	  anticipos_planta.ActiveConnection = MM_EXTRANET_STRING_STATUS
	  soldep = "SELECT DISTINCT f_fecha from etxpd where (c_referencia = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' and n_etapa=4) or (c_referencia = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' and n_etapa=5) or (c_referencia = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' and n_etapa=15) group by n_etapa order by n_etapa"
	  anticipos_planta.Source = soldep
	  ...
	  Igualrefe_atv.Open()
	   ...
	   ' SI ENCUENTRA LA REFERENCIA, BUSCA LA CUENTA DE GASTOS
	   if not Igualrefe_atv.eof then
	      strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & trim(Igualrefe_atv.Fields.Item("REFE01").Value) & "</font></td>" & chr(13) & chr(10) 'Refe Atlas
		  Set Cgastos_atv = Server.CreateObject("ADODB.Recordset")
	      Cgastos_atv.ActiveConnection = MM_EXTRANET_STRING_ATV
	      ...
	      Cgastos_atv.Open()
		   ...
		   'SINO ENCUENTRA EN "ATV", BUSCARÁ EN "ATM"
		   Set Igualrefe_atm = Server.CreateObject("ADODB.Recordset")
	       Igualrefe_atm.ActiveConnection = MM_EXTRANET_STRING_ATM
	       refeatlas_atm = "SELECT DISTINCT REFE01 from c01refer where refefor01 = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "' "
	       Igualrefe_atm.Source = refeatlas_atm
	  ...
	  'BUSCA CONTENEDORES
	    if session("GUsuarioAtlas") = "SI" and tmpTipo = "IMPORTACION" then
		         Set Rsconten = Server.CreateObject("ADODB.Recordset")
	             Rsconten.ActiveConnection = MM_EXTRANET_STRING
	             contenedor = "SELECT DISTINCT numcon40 from sscont40 where refcia40 = '" & trim(RsRep.Fields.Item("REFCIA01").Value) & "'  group by numcon40"
	             Rsconten.Source = contenedor
	             Rsconten.CursorType = 0
                 Rsconten.CursorLocation = 2
                 Rsconten.LockType = 1
	             Rsconten.Open()
'
	            if not Rsconten.eof then
		           strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif"">" & trim(Rsconten.Fields.Item("numcon40").Value) & "</font></td>" & chr(13) & chr(10)
                else
		           strHTML = strHTML&"<td width=""90"" nowrap><font color=""#000000"" size=""1"" face=""Arial, Helvetica, sans-serif""></font></td>" & chr(13) & chr(10)
                end if

		        Rsconten.close
                set Rsconten = Nothing
	      end if
	    RsReferencia.close
        set RsReferencia = Nothing
        strHTML = strHTML&"</tr>"& chr(13) & chr(10)
...
<%Function CampoSumaValoresFracc2(pCampo,pRefcia,padusec,ppatente)
...
dim tmpSumaValor2
 tmpSumaValor2=0
   Set RsValor1 = Server.CreateObject("ADODB.Recordset")
		...
		strSQL = "SELECT sum(ifnull("&pCampo&",0)) as SumaFracc FROM ssfrac02 WHERE refcia02='" & pRefcia & "' and adusec02='" & padusec & "' and patent02='"&ppatente&"' group by refcia02"
        strSQL = "SELECT sum("&pCampo&") as SumaFracc FROM ssfrac02 WHERE refcia02='" & pRefcia & "' and adusec02='" & padusec & "' and patent02='"&ppatente&"' group by refcia02"
...
dim tmpSumaValor2
 tmpSumaValor2=0
   Set RsValor1 = Server.CreateObject("ADODB.Recordset")
    ...
    strSQL = "select sum(d.mont21) as monto "&_

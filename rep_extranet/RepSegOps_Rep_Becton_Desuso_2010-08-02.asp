...
if  Session("GAduana") <> "" then %>
                    ...
                    'Response.Write(MM_EXTRANET_STRING)
                      ...
                      if request.form("tipRep") = "2" then
                         ...
                         Response.ContentType = "application/vnd.ms-excel"
                                    ...
                                    if mov="i" then
                                      if Vckcve="0" then
  sql1="SELECT feta01,fdoc01,FANT01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01,refcia01,totbul01, fecpag01, Obser01, " &_
     "if(fdoc01>feta01,if(fdoc01>frev01,fdoc01,frev01),if(feta01>frev01,feta01,frev01)) as fini, " &_
       "fecent01,numped01 FROM c01refer inner join ssdagi01 on refe01= refcia01 and  "&_
 ...
 sql1="SELECT feta01,fdoc01,FANT01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01," &_
 " if(fdoc01>feta01,if(fdoc01>frev01,fdoc01,frev01),if(feta01>frev01,feta01,frev01)) as fini, " &_
" fecent01,numped01 FROM  c01refer inner join ssdagi01 on refe01= refcia01 and firmae01<>'"&""&"'  " & permi & " and tipo01='1' "&_
" and fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " & " ORDER BY clie01, REFE01 "
   ...
   sql1="SELECT feta01,fdoc01,FANT01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01, " &_
  "  if(fdoc01>feta01,fdoc01,feta01) as fini ,numped01" & _
 ...
 "  and fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " & " ORDER BY clie01, REFE01"
  ...
  " fdsp01>='"&DateI&"'  and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " & " ORDER BY clie01, REFE01"
                                    ...
                                    '       " fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " &_
                                    '       " WHERE REFE01='RKU09-08737' " &_
                                    '       " ORDER BY clie01, REFE01"
				...
				<td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pedimento</td>
                    ...
                    -->
					 ...
					 '=================----aki se saca la dif entre la fec.entrada y despacho------------------
                                            ...
                                            'Response.Write("TimeDsp2=")
                                            'Response.Write(TimeDsp2)
                                            'Response.Write("<br>")
                                            'Response.Write("DateEnt=")
                                            'Response.Write(DateEnt)
                                            'Response.Write("<br>")
                                            'Response.Write("DateDsp=")
                                            'Response.Write(DateDsp)
                                            'Response.Write("<br>")
                                            ...
                                            'Response.Write("2010-03-05")
                                            'Response.Write("Valores=")
                                            'Response.Write(WeekDay("2010-03-05"))
                                            'Response.Write("Valores=")
                                            'Response.Write("07/03/2010")
                                            'Response.Write("Valores=")
                                            'Response.Write(WeekDay("07/03/2010"))
                                            'Response.End
                                            ...
                                            '----------------------
                                            TimeDsp2=0.0 'para asegurarno k no tenga ningun valor
...
'                                            Tsum=Tsum+TimeDsp2
	           ...
	           '  if strOficina="sap" then
               'if strOficina="sap" OR strOficina="dai" then
             ...
             '       TimeDsp=DateDiff("d",DateRev,DateDsp)
					   '  end if
                                      ...
                                      '----aki se saca la dif entre Revalidacion y despacho------------------
                                       ...
                                       '        if strOficina="sap" then
                                               'if strOficina="sap" OR strOficina="dai" then
                                                    'TimeDsp=DateDiff("d",DateIni,DateDsp)
                                                    diasemana=WeekDay(DateAdd("d",x,DateIni ))
                                       '        else
                                                    'TimeDsp=DateDiff("d",DateRev,DateDsp)
                                       ...
                                       '        end if
                                            ...
                                            'if DateIni <= "01/01/2010" then
                                            if DateDiff("d","01/01/2010",DateIni)  <= -1 then
                                                TimeDsp = TimeDsp -1
                                                if DateDiff("d","25/12/2009",DateIni)  <= -1 then
                                                  TimeDsp = TimeDsp -1
                                                end if
                                            end if
				...
				'----------------------------------------------------------PARA EXPO
                                       ...
                                       if mov<>"i" then
                                            ...
                                            'fecpag01
						                                if isdate(xDFini) then
                                               Diai = cstr(datepart("d",RS("fecpag01")))
                                               Mesi = cstr(datepart("m",RS("fecpag01")))
                                               Anioi = cstr(datepart("yyyy",RS("fecpag01")))
                                               DateIni = Diai & "/" &Mesi & "/"& Anioi
                                            end if
...
'             ix2=1
'			       MM_EXTRANET_STRING2 = "DRIVER={MySQL ODBC 3.51 Driver}; SERVER="& IPHost &"; DATABASE="&strOficina &"_status;             UID=EXTRANET; PWD=rku_admin; OPTION=16427"
...
'**********************************************************************************************
                                    ...
                                    <%if mov="i" then%>
                                         ...
                                         <%if xCONT <>"" then %>
                                            <td align="center"><font size="1" face="Arial"><%=Response.Write( xTipCont ) %></font></td>
                                            <!--  xCONT   -->
                                         <%else%>
                                            <td align="center"><font size="1" face="Arial">&nbsp;</font></td>
                                         <%end if%>
                                         ...
                                         <!--
                                         <%if RS("FANT01") <>"" then %>
                                            <td align="center"><font size="1" face="Arial"><%=RS("FANT01") %></font></td>
                                         <%else%>
                                            <td align="center"><font size="1" face="Arial">&nbsp;</font></td>
                                         <%end if%>
                                         -->
                                         ...
                                         <%if TimeDsp <>"" then %>
                                              ...
                                              <%else%>
                                                <td align="center" bgcolor="#0099CC"><font size="1" face="Arial"> 0 </font></td>
                                              <%end if%>
                                         <%else%>

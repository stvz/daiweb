...
strHTML = strHTML & "<td width=""80"" nowrap><strong><font color=""#FFFFFF"" size=""2"" face=""Arial, Helvetica, sans-serif"">TotalPagosHechos2</td>" & chr(13) & chr(10)
   ...
   strCtaGas=""
	 ...
	 dblsald31=0
        ...
        strSQL1="select A.cgas31,B.fech31,B.suph31, B.coad31, B.csce31, B.chon31, B.piva31, B.anti31,B.sald31 from d31refer as A LEFT JOIN e31cgast as B ON A.cgas31=B.cgas31 where B.esta31='I' and A.refe31='"&trim(strRefer)&"' " & permi2
...
'       if RsRep.Fields.Item("cveadu01").Value = "80" OR RsRep.Fields.Item("cveadu01").Value  = "24" THEN
      strSQL4="select numfac39,terfac39 from ssfact39 where refcia39='"&pRefer&"'"
     ...
     '    if RsRep.Fields.Item("cveadu01").Value = "80" OR RsRep.Fields.Item("cveadu01").Value  = "24" THEN 'Cambio pbm
      ...
      Set RsRep4=Nothing
        ...
        strSQL= "select fdsp01,rcli01,alea01 from c01refer where refe01 ='" &  pRefer & "'"

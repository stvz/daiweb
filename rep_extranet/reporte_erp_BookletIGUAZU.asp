...
validacion=""
 ...
 fechaini = "01/01/2009" 'trim(request.Form("txtDateIni"))
 fechafin = "15/07/2010" 'trim(request.Form("txtDateFin"))
...
"    where cc.rfccli18 in ('CIG041222UI7') and i.firmae01 is not null and i.firmae01 <> ''  and  i.fecpag01 >=  '"& finicio &"' and i.fecpag01 <= '"& ffinal &"' " & _
...
sqlAct =" select c.import36 as Campo ,c.cveimp36,c.refcia36  from "& oficina &"_extranet.ssdag"& tipope &"01 as i " & _
		...
		"    where c.refcia36 = '"& referencia &"' and c.cveimp36 = '18' and i.rfccli01 in ('CIG041222UI7')"
...
'		" where i.rfccli01 in ('CIG041222UI7') and i.refcia01 = '"&referencia&"'  and i.firmae01 <> ''   group by i.refcia01 "
...
"             inner join "& oficina &"_extranet.e21paghe as ep on ep.foli21 = dp.foli21 and year(ep.fech21) = year(dp.fech21) and ep.esta21 <> 'S' and ep.esta21 <> 'C'  and ep.tmov21 =dp.tmov21 " & _
"                  inner join  "& oficina &"_extranet.c21paghe as cp on cp.clav21 = ep.conc21 " & _
"    where  i.rfccli01 in ('CIG041222UI7')  and i.firmae01 <> ''  and cta.esta31 <> 'C'  and ep.conc21 in ("&conceptos&") and i.refcia01 = '"&referencia&"'  group by Ref,cgas31,conc21"

                    ...
                    'Response.Write(MM_EXTRANET_STRING)
                      ...
                      if request.form("tipRep") = "2" then
                         ...
                         Response.ContentType = "application/vnd.ms-excel"
                                    ...
                                    if mov="i" then
                                      if Vckcve="0" then
  sql1="SELECT feta01,fdoc01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01,refcia01,totbul01, fecpag01, Obser01, " &_
     "numped01,if(fdoc01>feta01,if(fdoc01>frev01,fdoc01,frev01),if(feta01>frev01,feta01,frev01)) as fini, " &_
       "fecent01 FROM c01refer inner join ssdagi01 on refe01= refcia01 and  "&_
       " firmae01<>'' and rfccli01='" & Vrfc & "' and tipo01='1'  and " &_
       "fdsp01 >= '" & DateI & "' and fdsp01 <= '" & DateF & "' and cveped01<>'R1' ORDER BY clie01, REFE01"
                                        'Response.Write("impo Vckcve=0 <br>")
                                        'Response.Write(sql1)
                                      else
                                        
sql1="SELECT c01.feta01, c01.fdoc01, c01.frev01, c01.fpre01, c01.fdsp01, c01.tipo01, c01.refe01, " &_
"c01.clie01, i.nomcli01, i.refcia01, i.totbul01, i.fecpag01, c01.Obser01, i.numped01, " &_ 
"if(c01.fdoc01 > c01.feta01, if(c01.fdoc01 > c01.frev01, c01.fdoc01, c01.frev01),if(c01.feta01 > c01.frev01, c01.feta01, c01.frev01)) as fini, " &_
"fecent01 FROM c01refer as c01 inner join ssdagi01 as i on refe01 = refcia01 and firmae01<>''  " & permi & " and tipo01='1' " &_
"and fdsp01 >= '" & DateI & "' and fdsp01 <= '" & DateF & "' and cveped01<>'R1' ORDER BY clie01, REFE01 "
										'Response.Write("impo Vckcve=1")
                                        'Response.Write(sql1)
                                      end if
                                    else
                                      if Vckcve="0" then
   ...
   sql1="SELECT feta01,fdoc01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01, " &_
  " numped01,desf0101, if(fdoc01>feta01,fdoc01,feta01) as fini " & _
 "FROM c01refer inner join ssdage01 on refe01= refcia01 and firmae01<>'"&""&"' and rfccli01='"&Vrfc&"' and tipo01='2' " &_
 " and fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " & " ORDER BY clie01, REFE01"
                                        '     Response.Write(sql1)
                                      else
   ...
   sql1="SELECT feta01,fdoc01,frev01, fpre01, fdsp01,tipo01, refe01,clie01, nomcli01, refcia01,totbul01, fecpag01, Obser01, " &_
      " numped01,desf0101, if(fdoc01>feta01,fdoc01,feta01) as fini " &_
  "FROM c01refer inner join ssdage01 on refe01= refcia01 and firmae01<>'"&""&"'  " & permi & " and tipo01='2'  and " &_
  " fdsp01>='"&DateI&"' and fdsp01<='"&DateF&"' and cveped01<>'"&"R1"&"' " & " ORDER BY clie01, REFE01"
                                      '       Response.Write(sql1)
                                      end if
                    ...
                    %>
                                    ...
                                    </font></strong><p align="left"><strong><font color="#000066" size="3" face="Arial, Helvetica, sans-serif">....REPORTE DE SEGUIMIENTO DE OPERACIONES UNILEVER...</font></strong></p>
        ...
        <tr bgcolor="#006699" class="boton">
                                    <%if mov="i" then%>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Ind</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Referencia</td>
										<td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pedimento</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Clientes</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Ejecutivo</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Descrip. Mercancia</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pais Origen</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Recepcion de Documentos</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Entrada</td>  
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Revalidacion</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Previo</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pago</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Despacho</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Tiempos de Despacho Ind. Grupo Zego</td>
								        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Tiempos de Despacho Indicador Unilever (Entrada vs Desp.)</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Observaciones Trafico</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Fecha C.Gastos</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">C.Gastos</td>
                                        <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Recepcion de C. Gastos</td>
									    <td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Tiempos de Facturacion Despacho vs Recepcion Cgastos</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Observaciones Administrador</td>
										<td align="center" width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Destino</td>
                                    <%else%>
										...
										<td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Numero de Factura</td>
										<td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pais Destino</td>
                                        <td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Recepcion de Documentos</td>
                                        <td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Entrada(eta)</td>
                                        <td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Pago</td>
                                        <td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Despacho</td>
								        <td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Tiempos de Despacho Entrada vs Despacho</td>
                    			        ...
                    			        <td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Recepcion de Cuenta de Gastos</td>
										<td width="100" nowrap><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Tiempos Facturacion Pago vs Cgastos</td>	
...
'                                            Tsum=Tsum+TimeDsp2
					  ...
					  '-==========================================================================================00					
	                                     ...
	                                     if strOficina="sap" then
		                                TimeDsp=DateDiff("d",DateIni,DateDsp)
					     else
                                      ...
                                      '----aki se saca la dif entre Revalidacion y despacho------------------
                                            ...
                                            Do While (x<=TimeDsp)
                                              x=x+1
                                              diasemana=WeekDay(DateAdd("d",x,DateRev))
                                              if diasemana=1 then
                                                t=t+1
                                              end if
                                              if diasemana=7 then
				...
				'----------------------------------------------------------PARA EXPO
					   ...
					   xDFdsp=RS("fdsp01")
                                      ...
                                      '----aki se saca la dif entre Revalidacion y despacho------------------
                                            ...
                                            Do While (x3<=TimeDsp)
                                              ...
                                              diasemana=WeekDay(DateAdd("d",x3,DateIni))
                                             if diasemana=1 then
                                                t3=t3+1
                                              end if
                                              if diasemana=7 then
					...
					'-----------------------------------------------------------------------------------------------------------------------
                              ...
                              '''''''''''''''
                                    ...
                                    sql2 =	"select distinct d01.REFE01 as referencia, " &_
											"d01.MARC01 as contenedor, " &_
											"d01.FCARTA01 as fecha, " &_
											"d01.cdes01, " &_
											"c07.nomb07 " &_
                                    ...
                                    IF NOT RS2.EOF THEN 'esta es en la tabla d01conte en la cual se encuentra los dos, si esta vacion, se lanza a la k sigue
                                        if not RS2.eof then
                                           ...
                                           RS2.MoveNext
                                           wend
										   destinos = Mid(destinos,1,len(destinos)-2)
                                       else
										  destinos = "No Capturado"
                                          xFCV = ""
                                          xCONT = ""
                                       end if
 ...
 '''''''''''''''******************************************************************************************
                                    sql4="select d31refer.cgas31 as cg, fech31,frec31,fdsp01 "  & _
                                         "from c01refer,d31refer inner join e31cgast on d31refer.cgas31=e31cgast.cgas31 and refe31='"&refe&"' AND esta31='I' where refe31=refe01"
                                         'Response.Write(sql3)
                                        ' Response.End
                                       set RS3=oConn.Execute(sql4)
                                       if not RS3.eof then
                                           TimeCG2=0
										   TimeAcuse2=0
										   TimeNew=0
                                           ...
                                           while not RS3.EOf
                                           if xCount2=1 then
                                                xFCG2 =  RS3("fdsp01").value
												xFCG3 = RS3("cg").value
												xFacuse2= RS3("frec31").value
												
                                          '--------AKI HACE EL CALCULO CON LA CUENTA DE GASTOS POR SER LA PRIMERA fecha---------
                                               IF mov="i" or  mov<>"i" THEN
                                                    xDFcg = RS3("fdsp01")
                                                    if isdate(xDFcg) then
                                                      Diaf = cstr(datepart("d",RS3("fdsp01")))
                                                      Mesf = cstr(datepart("m",RS3("fdsp01")))
                                                      Aniof = cstr(datepart("yyyy",RS3("fdsp01")))
                                                      DateCG = Diaf & "/" &Mesf & "/"& Aniof
                                                    end if
													'-----AGREGA APARTE SOLO (fecha_cuenta_gasto-fecha acuse de recibo)-------
													 xFacuse2= RS3("frec31")
													 
													 if isdate(xFacuse2) then
                                                      Diaf = cstr(datepart("d",RS3("frec31")))
                                                      Mesf = cstr(datepart("m",RS3("frec31")))
                                                      Aniof = cstr(datepart("yyyy",RS3("frec31")))
                                                      DateCGAcuse = Diaf & "/" &Mesf & "/"& Aniof
													  ...
													  if xFacuse2<>"" then
                                                      TimeNew=DateDiff("d",DateCG,DateCGAcuse)  
													  else
													  TimeNew=0
													  end if
													'--------------------------------------------------------------
                                                    'TimeNew=DateDiff("d",DateCGAcuse,DateCG)
													TimeNew=0
													TimeNew=DateDiff("d",DateCG,DateCGAcuse)
													pruebita=TimeNew
                                                '----aki se saca la dif entre despacho y Cuenta de Gastos------------------
                                                    ...
                                                    Do While (xx<TimeNew)
                                                      xx=xx+1
                                                      diasemanacg=WeekDay(DateAdd("d",xx,DateCG))
                                                      if diasemanacg=1 then
                                                        tt=tt+1
                                                      end if
                                                      if diasemanacg=7 then
                                                    ...
                                                    '----------------------
													TimeNew=0
                                                    TimeNew=xx-tt ' estos son los dias del Ind.CGastos
													if  xDFcg="" or xFacuse2="" then
													timenew=0
													end if
													
												   if TimeNew>TmaxCG then
                                                      TmaxCG=TimeNew
                                                    end if
                                                    if TimeNew<TminCG then
                                                      TminCG=TimeNew
                                                    end if
                                                    TsumCG2=TsumCG2+TimeNew
                                                END IF
                                           '-------hasta aki es lo del ind de cuenta de gastos----------
                                           else
                                                xFCG2  = xFCG2 & "," & RS3("fdsp01").value
												xFacuse2 = xFacuse2 & "," & RS3("frec31").value
                                           end if
                                           xCount = xCount + 1
                                           RS3.MoveNext
                                           wend
...
'**************************************************************PARA LAS MERCANCIAS ************************************* 
            ...
            strSQL="SELECT * " &_
		    " FROM SSFRAC02 WHERE REFCIA02='"&referencia&"' "
...
'*************************************************************************************************************************
                                    ...
                                    <%if mov="i" then%>
										 ...
										 <td align="center" nowrap><font size="1" face="Arial">&nbsp;</font></td>
										  <%if mercancia<>"" then %>
								 <td align="center" nowrap><font size="1" face="Arial"><%response.Write(mercancia)%></font></td>
										 <%else%>
										 <td align="center"><font size="1" face="Arial">&nbsp;</font></td>
                                         <%end if%>
 									     <%if paisOD <>"" then %>
									<td align="center" nowrap><font size="1" face="Arial"><%response.Write(paisod)%></font></td>
										 <%else%>
										 <td align="center"><font size="1" face="Arial">&nbsp;</font></td>
                                         <%end if%>
                                         <%if RS("fdoc01") <>"" then %>
                    ...
                    <td align="center" bgcolor="#0099CC"><font size="1" face="Arial"><%=Response.Write( TimeDsp ) %></font></td>
                     ...
                     <td align="center" bgcolor="#0099CC"><font size="1" face="Arial"><%=Response.Write( TimeDsp2 ) %></font></td>
                                  ...
                                  <td align="left" nowrap><font size="1" face="Arial"><%RESPONSE.Write(observacion)%></font></td>
                                         ...
                                         <%end if%>
										 <%if xFCG <>"" then %>
                                         <td align="center"><font size="1" face="Arial"><%=Response.Write( xFCG22 ) %></font></td>                                         <%else%>
                                            <td align="center"><font size="1" face="Arial">----</font></td>
                                         <%end if%>
                                         ...
                                         <%end if%>
										  ...
										  <%if timenew<>"" then %>
       			                         <td align="center" ><font size="1" face="Arial"><%=Response.Write(Timenew)%></font></td>
                                         <%else%>
                                          <td align="center"><font size="1" face="Arial">&nbsp;</font></td>
                                         <%end if%>

                                          <td align="center" ><font size="1" face="Arial">&nbsp;</font></td>
										  <td align="center" ><font size="1" face="Arial"><%=destinos%></font></td>
							...
							<%else%>
							 ...
							 <td align="center" nowrap><font size="1" face="Arial"><%response.Write(paisod)%></font></td>
                                  ...
                                  <td align="left" nowrap><font size="1" face="Arial"><%RESPONSE.Write(observacion)%></font></td>
                                         ...
                                         <%end if%>
										 <%if xFCG <>"" then %>
                                       <td align="center"><font size="1" face="Arial"><%=Response.Write( xFCG22 ) %></font></td>
                                         <%else%>
                                            <td align="center"><font size="1" face="Arial">----</font></td>
                                         <%end if%>
	                               ...
	                               <%if observacion <>"" then %>
                                      <td align="left" nowrap><font size="1" face="Arial">&nbsp;</font></td>
                                   <%else%>
                                      <td align="center"><font size="1" face="Arial">&nbsp;</font></td>
                                   <%end if%>
                                   <%end if%>
